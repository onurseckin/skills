...
export const CAPTURE_COMMANDS: readonly CommandSpec[] = [
  {
    ...
    flags: [
      ...
      optionalFlag("format", "string", "Configuration format: yaml or json (default: yaml).", "yaml"),
      optionalFlag("preset", "string", "Preset template: standard-dashboard, marketing-site, mobile-app, full-matrix.", "standard-dashboard"),
  ...
  },
  {
    ...
    flags: [
      optionalFlag("run", "string", "Capsule run root for artifact and screenshot ledger ingestion."),
      ...
      optionalFlag("actor", "string", "Actor recorded in ledger captures (default: capture-runner)."),
    ],
    readsStdin: false,
    takesRemainder: false,
    exitCodes: DEFAULT_EXIT_CODES,
  ...
  },
  {
    ...
    flags: [
      ...
      optionalFlag("manifest-dir", "string", "Directory containing .manifest.json companion files."),
