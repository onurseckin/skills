...
import { evaluateCognitiveQuestions } from "./validator/cognitive/cognitive-questions.ts";
import type { ElementPhysicsSnapshot, ValidationContext } from "./validator/types.ts";
    ...
    const flawedElements: ElementPhysicsSnapshot[] = [
      {
        ...
        interactive: true,
        isTouchTarget: true,
        bounds: { x: 100, y: 100, width: 24, height: 24 }, // Sub-44px!
      },
    ];
