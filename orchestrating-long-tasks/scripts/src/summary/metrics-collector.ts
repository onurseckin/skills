...
export function collectMetrics(input: MetricsInput): RollupMetrics {
  ...
  // Whole-run edges: prompt (1 exchange, 200 tokens) + critic (1 exchange, 450 tokens) = 2 exchanges, 650 tokens
  // Task edges: spawn (1 exch, 350 tok) + submit (1 exch, 650 tok) + join (1 exch, 300 tok) = 3 exchanges, 1300 tokens per task
  // Dependency edges: 1 exchange, 420 tokens per dependency
  // Pushback repair edges: totalPushbackExchanges (280 tokens per finding/pushback)
