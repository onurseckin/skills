...
import { validateCompletionArtifactVerification } from "../../src/workflow/completion/artifact-verification.ts";
...
const argv = ["bun", "test", "tests/workflow/trusted-host-gates.test.ts"];
