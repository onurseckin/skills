...
import { validateGraph } from "../../src/graph/validate-graph.ts";
import { validateRequirements } from "../../src/requirements/validate-requirements.ts";
import { validateReview } from "../../src/workflow/review/validate-review.ts";
import { validateReport } from "../../src/workflow/submission/validate-report.ts";
import type { TaskRecord } from "../../src/workflow/types.ts";

const path = fileURLToPath(new URL("../../../references/schema-examples.md", import.meta.url));
