...
import { linuxLibcCandidates, tryExclusiveFlock } from "../../src/platform/flock-ffi.ts";
import { withRunLock } from "../../src/platform/run-lock.ts";

const lockModule = new URL("../../src/platform/run-lock.ts", import.meta.url).pathname;
