...
Every harness operation runs through `orchestrating-long-tasks/scripts/harness.ts` (or the installed
entrypoint `~/.agents/skills/orchestrating-long-tasks/scripts/harness.ts`).
