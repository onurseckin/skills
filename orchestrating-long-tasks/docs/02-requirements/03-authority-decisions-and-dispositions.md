...
- *"Drop the legacy SQLite tables and migrate to Postgres after my approval."*
- *"Deploy the container to production if all tests pass."*
- *"Delete all orphaned S3 buckets."*
