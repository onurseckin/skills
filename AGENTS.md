...
1. **Gate 1: Headless Mechanical Capture & DOM Metrics (`ui-headless-validator` / `ui-mechanic-validator`)**:
...
2. **Gate 2: Optical Visual Inspection & Socratic Critique (`ui-optical-validator` / `ui-validator`)**:
