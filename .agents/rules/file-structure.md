...
- Maximum 10 direct .ts/.tsx files per directory (fanout limit). Codebase authority: `scripts/modularity/inventory/fanout.ts:FANOUT_LIMIT`. (Note: an index.ts facade exemption is currently under review as T-867e).
