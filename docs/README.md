...
Welcome to the central repository documentation index for the **`@onurseckin/skills`** multi-skill ecosystem.
...
## 1. Repository Architecture and File System Map
...
|  |   |-- olt/                                 --> 17-Chapter Architecture Book & Reference Hub (Diataxis)|
...
|  |   `-- archive/                                                                                       |
|  |       `-- completed-plans/                 --> Archive of completed architectural execution plans   |
|  |                                                                                                      |
...
|                                |                                                                        |
|                                v spawns concurrently (Paired Workforce)                                 |
|  +----------------------------------------------+----------------------------------------------------+  |
...
## 3. Diátaxis Documentation Navigation Matrix
...
- **Tutorials (Learning-Oriented)**: Step-by-step onboarding journeys providing practical hands-on experience without cognitive overload.
- **How-To Guides (Problem-Oriented)**: Focused recipes and operational playbooks designed to solve specific challenges during runtime execution.
- **Explanation (Understanding-Oriented)**: Deep theoretical foundations, architectural rationale, mathematical proofs, and system invariants.
- **Reference (Information-Oriented)**: Authoritative technical specifications, CLI commands, data schemas, error codes, and role contracts.
...
|    -> [Quickstart Tutorial](./olt/reference/quickstart.md)| -> [Foundations & Invariants](./olt/architecture/01-foundations/01-01-zero-assumption-philosophy.md)|
...
|    -> [Run Playbook](../olt/references/run-playbook.md)| Brent's theorem P = ceil(W / S) & wave scaling     |
|    -> [Reference Index](./olt/reference/index.md)| -> [Topological DAG Scheduler](./olt/architecture/06-topological-scheduler-dags/06-01-dag-compilation-and-kahns-algorithm.md)|
|                                              |    -> [Concurrency & Straggler SLA](./olt/architecture/05-concurrency-straggler-sla/05-01-brent-work-span-theorem.md)|
|                                              |                                                          |
|                                              |  * Adversarial Validation Philosophy                     |
|                                              |    Separation of concerns & independent proof            |
|                                              |    -> [Adversarial Validation](./olt/architecture/08-adversarial-validation-repair/08-01-adversarial-validation-philosophy.md)|
|                                              |                                                          |
|                                              |  * 4-Tier Hierarchy & Supervisory Purity                 |
|                                              |    Architectural defense against context pollution       |
|                                              |    -> [Four-Tier Hierarchy](./olt/architecture/02-four-tier-hierarchy/02-01-the-four-tier-agent-model.md)|
...
|                                              |    -> [Harness CLI Engine](./olt/architecture/14-harness-cli-and-command-engine/14-01-lifecycle-and-run-commands.md)|
...
|    -> [Durability & Merkle Chains](./olt/architecture/10-durability-recovery-capsules/10-01-capsule-filesystem-anatomy.md)| -> [Protocol Specification](../olt/references/protocol.md)|
|                                              |    -> [State Schemas](./olt/architecture/15-state-schemas-and-event-ledger/15-01-capsule-filesystem-layout.md)|
...
|    -> [Worktree Branching](./olt/architecture/11-worktree-branching-honesty/11-01-out-of-repo-git-worktree-isolation.md)| Comprehensive taxonomy of agent error classes    |
|    -> [Verification Engines](./olt/architecture/17-verification-engines-and-gates/17-01-typecheck-engine.md)| -> [Error Catalog](./olt/architecture/16-error-catalog-and-blunders/16-01-exit-status-hierarchy.md)|
+----------------------------------------------+----------------------------------------------------------+
```

---

## 4. Categorized Documentation Index
...
### 4. 17-Chapter OLT Architecture Book and Reference Hub

- [**OLT Master Documentation Hub**](./olt/README.md): Master portal and navigation hub.
- [**Documentation Portal Entrypoint**](./olt/index.md): Ecosystem introduction and Diataxis topology overview.
...
- [**Architecture Book Master Index**](./olt/architecture/index.md): Complete 17-chapter theoretical and algorithmic architecture specification.
  - [Chapter 01: Mental Model & Architectural Foundations](./olt/architecture/01-foundations/01-01-zero-assumption-philosophy.md)
  - [Chapter 02: Four-Tier Workforce Hierarchy](./olt/architecture/02-four-tier-hierarchy/02-01-the-four-tier-agent-model.md)
  - [Chapter 03: Mind Product Owner & Infinite Cadence](./olt/architecture/03-mind-product-owner/03-01-infinite-autonomous-cadence.md)
  - [Chapter 04: Continuous Preplanning Factory](./olt/architecture/04-continuous-preplanning-factory/04-01-prompt-ingestion-and-sha256-binding.md)
  - [Chapter 05: Concurrency Scaling & Straggler SLA](./olt/architecture/05-concurrency-straggler-sla/05-01-brent-work-span-theorem.md)
  - [Chapter 06: Topological DAG Scheduler](./olt/architecture/06-topological-scheduler-dags/06-01-dag-compilation-and-kahns-algorithm.md)
  - [Chapter 07: Distributed Task Leasing & Execution](./olt/architecture/07-distributed-leasing-execution/07-01-monotonic-lease-protocol-and-tokens.md)
  - [Chapter 08: Adversarial Validation & Monotonic Repair](./olt/architecture/08-adversarial-validation-repair/08-01-adversarial-validation-philosophy.md)
  - [Chapter 09: Falsifiable Evidence & Completion Gates](./olt/architecture/09-falsifiable-evidence-gates/09-01-falsifiable-evidence-classes.md)
  - [Chapter 10: Durability, Recovery & Merkle Chains](./olt/architecture/10-durability-recovery-capsules/10-01-capsule-filesystem-anatomy.md)
  - [Chapter 11: Worktree Branching & Honesty Gates](./olt/architecture/11-worktree-branching-honesty/11-01-out-of-repo-git-worktree-isolation.md)
  - [Chapter 12: Flock Mailboxes & Telemetry](./olt/architecture/12-flock-mailboxes-and-tui/12-01-inter-agent-mailbox-directory-protocol.md)
  - [Chapter 13: Policy, RBAC & Fail-Closed Engine](./olt/architecture/13-policy-rbac-failclosed-engine/13-01-mechanical-rbac-compiler.md)
  - [Chapter 14: Harness CLI & Command Engine](./olt/architecture/14-harness-cli-and-command-engine/14-01-lifecycle-and-run-commands.md)
  - [Chapter 15: State Schemas & Event Ledger](./olt/architecture/15-state-schemas-and-event-ledger/15-01-capsule-filesystem-layout.md)
  - [Chapter 16: Error Catalog & Empirical Blunders](./olt/architecture/16-error-catalog-and-blunders/16-01-exit-status-hierarchy.md)
  - [Chapter 17: Verification Engines & Gate Provers](./olt/architecture/17-verification-engines-and-gates/17-01-typecheck-engine.md)
...
## 5. Quality Gates and Contributing
...
4. **Link and Anchor Integrity**: All relative links within documentation files must resolve to valid on-disk targets without broken or circular references.
5. **No Static Planning Files in Git**: Runtime execution plans and capsule logs reside exclusively under `.olt/capsules/<run-id>/`.

### Local Invariant Validation Pipeline

To verify repository invariants and documentation integrity locally:
...
# Verify ESLint rules and zero-suppression policy
bun run lint
```

All contributions must pass all automated test suites and maintain 100% relative link resolution before being merged.
