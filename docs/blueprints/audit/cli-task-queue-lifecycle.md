# CLI Layer Architecture Audit: Cli Task Queue Lifecycle

**Target Files:** commands/task-ops.ts, commands/todo-ops.ts, commands/task-*.ts
**Things to Look For Count:** 15
