...
> **Tracking ID:** `fb-cluster-core-95df9930`  
...
├─────────────────────────────────────────────────────────────────────────────────────────────┤
│  Cluster ID: cluster-core-95df9930                                                       │
...
### Task 1.1: Defect Remediation: Missing Repository Policy

- **Owner / Tier:** Tier 3 Implementer + Independent Validator
- **Defect Ref:** `defect-1788061458974-3e79ya` (Error Code: `MISSING_POLICY`)
- **Write Scope:** `olt/scripts/src/core/`
- **Read-Only Scope:** `olt/scripts/src/`
- **Acceptance Criteria (Stub Must Fail):**
  - Remediate: Repository policy file .olt/policy.json does not exist.
  - Zero TypeScript `any`, zero compiler suppressions, zero comments in .ts files.
  - Command: `bun test tests/unit/core/` (100% PASS).

### Task 1.2: Defect Remediation: Invalid Session Authority

- **Owner / Tier:** Tier 3 Implementer + Independent Validator
- **Defect Ref:** `defect-1788061458975-gagaqw` (Error Code: `GOVERNANCE_INTEGRITY_FAULT`)
- **Write Scope:** `olt/scripts/src/core/`
- **Read-Only Scope:** `olt/scripts/src/`
- **Acceptance Criteria (Stub Must Fail):**
  - Remediate: No valid session authority found in .session.json or active capsule state.
  - Zero TypeScript `any`, zero compiler suppressions, zero comments in .ts files.
  - Command: `bun test tests/unit/core/` (100% PASS).
...
- **Owner / Tier:** Tier 3 Implementer + Independent Validator
- **Defect Ref:** `defect-1788061466820-j5kdg4` (Error Code: `ROLE_BOUNDARY_DEVIATION`)
- **Write Scope:** `olt/scripts/src/core/`
- **Read-Only Scope:** `olt/scripts/src/`
- **Acceptance Criteria (Stub Must Fail):**
...
- **Owner / Tier:** Tier 3 Implementer + Independent Validator
- **Defect Ref:** `defect-1788061466829-1jy3fr` (Error Code: `ROLE_BOUNDARY_DEVIATION`)
- **Write Scope:** `olt/scripts/src/core/`
- **Read-Only Scope:** `olt/scripts/src/`
- **Acceptance Criteria (Stub Must Fail):**
...
### Task 1.5: Defect Remediation: Skill Compliance Incident: ROLE_BOUNDARY_DEVIATION

- **Owner / Tier:** Tier 3 Implementer + Independent Validator
- **Defect Ref:** `defect-1788061542969-wq6jmo` (Error Code: `ROLE_BOUNDARY_DEVIATION`)
- **Write Scope:** `olt/scripts/src/core/`
- **Read-Only Scope:** `olt/scripts/src/`
- **Acceptance Criteria (Stub Must Fail):**
  - Remediate: Coordinator modified repository source code directly
...
### Task 1.6: Defect Remediation: Skill Compliance Incident: ROLE_BOUNDARY_DEVIATION

- **Owner / Tier:** Tier 3 Implementer + Independent Validator
- **Defect Ref:** `defect-1788061542978-ldpfpi` (Error Code: `ROLE_BOUNDARY_DEVIATION`)
- **Write Scope:** `olt/scripts/src/core/`
- **Read-Only Scope:** `olt/scripts/src/`
- **Acceptance Criteria (Stub Must Fail):**
  - Remediate: Supervisor performed direct edit
...
| :---------------------------- | :--------------- | :------------------ |
| `defect-1788061458974-3e79ya` | Task 1.x         | `tests/unit/core/`  |
| `defect-1788061458975-gagaqw` | Task 1.x         | `tests/unit/core/`  |
| `defect-1788061466820-j5kdg4` | Task 1.x         | `tests/unit/core/`  |
| `defect-1788061466829-1jy3fr` | Task 1.x         | `tests/unit/core/`  |
| `defect-1788061542969-wq6jmo` | Task 1.x         | `tests/unit/core/`  |
| `defect-1788061542978-ldpfpi` | Task 1.x         | `tests/unit/core/`  |
