...
> **Tracking ID:** `fb-cluster-mind-d3a97b1b`  
...
├─────────────────────────────────────────────────────────────────────────────────────────────┤
│  Cluster ID: cluster-mind-d3a97b1b                                                       │
│  Planned At: 2026-08-30T08:59:27.431Z                                                    │
│  Backlog Count: 0                                                                        │
│  Defect Count:  1                                                                        │
└─────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
- **Defect Ref:** `defect-1788067801429-ywltx7` (Error Code: `LIVE_STAGNATION_DETECTED`)
- **Write Scope:** `olt/scripts/src/mind/`
- **Read-Only Scope:** `olt/scripts/src/`
- **Acceptance Criteria (Stub Must Fail):**
  - Remediate: Tier 0 Mind has been idle for 206s (threshold: 120s). Mode A wakeup injection synthesized.
...
| :---------------------------- | :--------------- | :------------------ |
| `defect-1788067801429-ywltx7` | Task 1.x         | `tests/unit/mind/`  |
