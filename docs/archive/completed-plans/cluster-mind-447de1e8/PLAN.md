...
> **Tracking ID:** `fb-cluster-mind-447de1e8`  
...
├─────────────────────────────────────────────────────────────────────────────────────────────┤
│  Cluster ID: cluster-mind-447de1e8                                                       │
│  Planned At: 2026-08-31T02:25:28.184Z                                                    │
│  Backlog Count: 0                                                                        │
│  Defect Count:  1                                                                        │
└─────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
- **Defect Ref:** `defect-1788143079140-7rq0vv` (Error Code: `LIVE_STAGNATION_DETECTED`)
- **Write Scope:** `olt/scripts/src/mind/`
- **Read-Only Scope:** `olt/scripts/src/`
- **Acceptance Criteria (Stub Must Fail):**
  - Remediate: Tier 0 Mind has been idle for 3657s (threshold: 120s). Mode A wakeup injection synthesized.
...
| :---------------------------- | :--------------- | :------------------ |
| `defect-1788143079140-7rq0vv` | Task 1.x         | `tests/unit/mind/`  |
