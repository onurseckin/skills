...
```text
Task Leased Write Scope: ["olt/docs/05-task-execution"]

Valid File Modifications:
  ✅ olt/docs/05-task-execution/01-leasing-and-heartbeats.md
  ✅ olt/docs/05-task-execution/02-atomic-filesystem-scopes.md

Invalid File Modifications (Rejected with Error):
  ❌ olt/docs/01-foundations/01-why-long-tasks-fail.md  [Out of scope]
  ❌ olt/package.json                                  [Out of scope]
