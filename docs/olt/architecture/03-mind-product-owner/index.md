...
| **Mind Init & Governance Bootstrap**  | [mind-init.ts](../../../../olt/scripts/src/cli/commands/mind-init.ts)              | `mindInitCommand()`, `MindInitGovernanceStatus`, `MindInitResult`                 |
| **Mind Wake & Charter Verification**  | [mind-wake.ts](../../../../olt/scripts/src/cli/commands/mind-wake.ts)              | `mindWakeCommand()`                                                               |
| **Mind Observation & Discovery**      | [mind-observe.ts](../../../../olt/scripts/src/cli/commands/mind-observe.ts)        | `mindObserveCommand()`, `formatMindObserveBrief()`, `MindObserveResult`           |
| **Mind Admission & Decline Transact** | [mind-admit.ts](../../../../olt/scripts/src/cli/commands/mind-admit.ts)            | `mindAdmitCommand()`, `mindDeclineCommand()`, `formatMindAdmitBrief()`            |
| **Mind Pulse Dispatch & Scheduling**  | [mind-pulse.ts](../../../../olt/scripts/src/cli/commands/mind-pulse.ts)            | `mindPulseCommand()`                                                              |
