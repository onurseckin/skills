# OLT Documentation Engineering Charter and Authoring Standards

[Previous: Master Documentation Hub](README.md) | [Documentation Portal](index.md) | [Canonical Guidelines SSoT](../../olt/docs/guidelines.md) | [Next: Quickstart Tutorial](reference/quickstart.md)

---

## 1. Executive Charter and Canonical Source of Truth
...
|                                                                                                  |
|   +---------------------------+         +---------------------------+                            |
|   | Diataxis Documentation    |  --->   | Canonical SSoT Guidelines |                            |
|   | Taxonomy (Procida)        |         | (olt/docs/guidelines.md)  |                            |
|   +-------------+-------------+         +-------------+-------------+                            |
|                 |                                     |                                          |
|                 v                                     v                                          |
|   +---------------------------+         +---------------------------+                            |
...
## 2. Theoretical Pedagogy and Standards Alignment

The OLT documentation ecosystem is grounded in two industry-standard technical frameworks:

### 2.1 The Diataxis Documentation Framework

Created by Daniele Procida, Diataxis partitions technical documentation across two fundamental cognitive axes: Learning vs. Applying and Practical Action vs. Theoretical Cognition.

```
+--------------------------------------------------------------------------------------------------+
|                            THE DIATAXIS DOCUMENTATION MATRIX IN OLT                              |
+----------------------------------------------+---------------------------------------------------+
...
|  Location: docs/olt/reference/quickstart     |  Location: docs/olt/architecture/ & docs/book/    |
+----------------------------------------------+---------------------------------------------------+
...
### 2.2 The Open Agent Skills Standard (`agentskills.io`) & Progressive Disclosure
...
3. **Progressive Execution (On-Demand References)**: Agents query deep architecture chapters (`docs/book/`) and reference guides (`docs/olt/reference/`) on-demand. When executing CLI commands, only the stdout brief enters the LLM context, preserving context budget ($< 150{,}000$ tokens).

---

## 3. Information Weight and Document Sizing Invariants
...
### 3.1 Document Decomposition Criteria
...
## 5. Visual Architecture and Diagram Standards

Every technical document across `docs/olt/` and `docs/book/` must contain at least one visual diagram:
...
```markdown
[Previous: Master Documentation Hub](README.md) | [Chapter Index](architecture/index.md) | [All Chapters Index](../../docs/book/SUMMARY.md) | [Next: Quickstart](reference/quickstart.md)
```

For the authoritative single source of truth guidelines, refer to [`olt/docs/guidelines.md`](../../olt/docs/guidelines.md).
