...
## 1. Theoretical Pedagogy & Standards Alignment
...
## 2. Information Weight & Document Sizing Invariants
...
## 5. Universal Clean 4-Way Navigation Mesh
...
- **Link Integrity**: 100% of relative links must resolve to existing on-disk targets (verified by unit test suite).
- **Zero Emojis**: Emojis are strictly banned from navigation bars, headings, tables, and prose.

---

## 6. Multi-Round Cognitive Review & Reflog Safety
