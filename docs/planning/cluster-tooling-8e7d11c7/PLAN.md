...
# Gate 4: Full Tooling Static Verification Interlock
...
- Concurrency Hard-Lock: Total active subagents bounded by the $\le 50$ fleet cap.
...
| :-------------------------------------------------------- | :----------------------------------------------------- | :----------------------------------------------------------------- | :------------------------------------------------------- |
| `fb-olt-unified-master-doctor-engine`                     | Master Doctor Auto-Healing & 8-Engine Diagnostic Suite | `task-tool-1.1`, `task-tool-1.2`, `task-tool-1.4`                  | `bun test tests/unit/reporting/master-doctor.test.ts`    |
| `defect-doctor-ast-purity-test-regex-false-positive`      | AST Purity Engine Test Regex Exemption                 | `task-tool-1.3`                                                    | `bun test tests/unit/reporting/master-doctor.test.ts`    |
| `defect-doctor-stagnation-unactionable-gap`               | Automated Diagnostic Stagnation Break Interlock        | `task-tool-1.2`                                                    | `bun test tests/unit/reporting/master-doctor.test.ts`    |
| `fb-1788021600000-mandatory-mailbox-communication-engine` | Mailbox IPC Messaging System & CLI Commands            | `task-tool-2.1`, `task-tool-2.2`, `task-tool-2.3`, `task-tool-2.4` | `bun test tests/unit/communication/mailbox-ipc.test.ts`  |
| `fb-1788020500000-os-push-audio-notification-engine`      | Native OS Audio & Visual Push Notifications            | `task-tool-3.1`, `task-tool-3.2`                                   | `bun test tests/unit/reporting/os-notifications.test.ts` |
