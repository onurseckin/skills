...
import type { AggregatedDefect, DefectEntry, DefectResolutionProof } from "./types.ts";
...
export function resolveDefectRecord<T extends DefectEntry | AggregatedDefect>(
  defect: T,
  proof: DefectResolutionProof,
  options: { readonly requireCommitSha?: boolean | undefined } = {},
): T {
...
export function resolveDefect(
  ...
  return resolveDefectRecord(defect, proof, options);
}
