...
import type { CommandAttemptRecord } from "../../../core/contracts/index";
import { atomicWriteJson } from "../../../core/durable-write";
import { readBoundedBytes } from "../../../core/json";
import { activityMetadata, raceWithTimeout } from "./attempt-support";
import { portableArtifactPath } from "../core/artifact-paths";
import { classifySignals, type FailureSignals } from "../core/classify-failure";
...
import type { WatchdogOutcome } from "../telemetry/watchdog";
import type { ActivityRecord } from "../reconciliation/activity-record";
import type { ProcessIdentity } from "../reconciliation/descendant-tracker";
import {
  settledAttemptTerminalProof,
  strongAttemptTerminalProof,
  type AttemptIntentController,
} from "../execution/attempt-intent";
