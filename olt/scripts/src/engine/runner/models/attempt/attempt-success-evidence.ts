...
import { classifySignals, type FailureSignals } from "../../core/classify-failure.ts";
import { outputEvidenceIssues } from "../../receipt/output-evidence.ts";
import type {
  AttemptResult,
  BunSpawnApi,
...
import type { WatchdogOutcome } from "../../telemetry/watchdog.ts";
import type { ActivityRecord } from "../../reconciliation/activity-record.ts";
import type { ProcessIdentity } from "../../reconciliation/descendant-tracker.ts";
import {
