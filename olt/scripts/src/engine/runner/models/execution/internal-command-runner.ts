...
import { canonicalCommandFingerprint, commandId } from "../command/command-id.ts";
import { portableArtifactPath } from "../../core/artifact-paths.ts";
import type { CommandRuntimeCapability } from "./command-execution-snapshot.ts";
import {
  assertCommandIntentSize,
  assertCommandRecordSize,
} from "../command/command-record-size.ts";
import {
  executeInternalPreparedCommand,
  type InternalExecutionDependencies,
} from "../../core/execute-internal-command.ts";
import { captureGatePathBindings, executionArgv } from "../../signing/gate-path-bindings.ts";
import { TRUSTED_HOST_ASSURANCE } from "../../signing/gate-observation.ts";
import { assertRunnerPlatform, reserveCommandRoot } from "../../core/platform-policy.ts";
import {
  assertCommandIdentities,
  normalizeCommandOptions,
  policyRecord,
} from "../../core/policy.ts";
import { createCommandSigningCapability } from "../../execution/attempt-disposition-capability.ts";
import {
  isGitGateCommand,
  isRestrictedGitGate,
  restrictedGateGitArgv,
} from "../../core/restricted-git-gate.ts";
