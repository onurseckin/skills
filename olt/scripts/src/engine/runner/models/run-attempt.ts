...
import { ActivityRecord } from "../reconciliation/activity-record";
import { settleBounded, settleTrackerBeforeOutcome } from "./attempt-support";
import { finalizeSuccessfulAttempt } from "./attempt-success-evidence";
import { startAttemptIntent, type AttemptIntentController } from "../execution/attempt-intent";
import { FailureEvidence } from "../receipt/failure-evidence";
import { DescendantTracker, type ProcessIdentity } from "../reconciliation/descendant-tracker";
import { addedPipeHandles, OWNERSHIP_ENV, runnerPipeHandles } from "../core/pipe-ownership";
...
} from "../execution/attempt-failure-cleanup";
