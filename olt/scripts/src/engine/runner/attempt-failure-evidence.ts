...
import type { CommandAttemptRecord, CommandLogMetadata } from "../../core/contracts/commands.ts";
...
import { retainedActivityTimes } from "./attempt-intent.ts";
import { portableArtifactPath } from "./artifact-paths.ts";
import { assertCommandAttemptSize, boundedEvidenceError } from "./command-record-size.ts";
import { outputEvidenceIssues } from "./output-evidence.ts";
import type { AttemptResult, NormalizedCommandOptions } from "./types.ts";
