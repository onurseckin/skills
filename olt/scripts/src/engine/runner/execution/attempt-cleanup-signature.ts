...
import type { JsonObject } from "../../../core/contracts/index";
import { canonicalJsonBytes, sha256Bytes } from "../../../core/json";
import {
  ...
  signalLedgerValid,
  transitionIssues,
} from "./attempt-cleanup-validation";
...
export interface CleanupDispositionPayload extends JsonObject {
  ...
  reason: string;
  signals_sent: string[];
  root_pid_identity: import("../../../core/contracts/index").CommandProcessIdentity | null;
