...
import { initRun, transact } from "../../engine/store/index.ts";
    ...
    try {
      ...
      for (const summary of genericSummaries) {
        ...
        try {
          ...
          expect(harnessErr.code).toBe("INVALID_ARGUMENT");
          expect(harnessErr.message).toContain(
            "critic summary cannot be a superficial rubber-stamp",
          );
        }
        expect(threw).toBe(true);
      }
...
describe("Static Invariant Verification: Zero TypeScript any & Zero Suppressions", () => {
  it("verifies task review dual channel test and support files contain zero any and zero suppressions", () => {
    const filesToAudit = [
      "/Users/onurseckinsenoglu/repos/skills/olt/scripts/src/cli/commands/task-review-support.ts",
      "/Users/onurseckinsenoglu/repos/skills/olt/scripts/src/cli/commands/task-review.ts",
      "/Users/onurseckinsenoglu/repos/skills/olt/scripts/src/cli/commands/critic-ops.ts",
      "/Users/onurseckinsenoglu/repos/skills/olt/scripts/src/cli/commands/task-review-dual-channel.test.ts",
    ];
