...
export const EVENTS_TRACE_SPEC: CommandSpec = {
  ...
  flags: [
    ...
    optionalFlag("box-style", "string", "Terminal border rendering style."),
    optionalFlag("filter-kind", "string", "Filter steps by event kind."),
  ],
  readsStdin: false,
  takesRemainder: false,
  exitCodes: DEFAULT_EXIT_CODES,
...
export const NOTIFY_TEST_SPEC: CommandSpec = {
  ...
  flags: [
    ...
    optionalFlag("json", "bool", "Output structured JSON report.", false),
    optionalFlag("commit", "string", "Commit SHA for notification test."),
    optionalFlag("details", "string", "Notification details body."),
    optionalFlag("duration-ms", "int", "Execution duration in milliseconds."),
    optionalFlag("phase", "string", "Phase name for notification."),
    optionalFlag("silent", "bool", "Suppress audio notification."),
    optionalFlag("sound", "bool", "Trigger sound effect."),
    optionalFlag("subtitle", "string", "Notification subtitle string."),
    optionalFlag("tasks", "string", "Affected tasks list."),
    optionalFlag("title", "string", "Notification title string."),
  ],
  readsStdin: false,
  takesRemainder: false,
  exitCodes: DEFAULT_EXIT_CODES,
