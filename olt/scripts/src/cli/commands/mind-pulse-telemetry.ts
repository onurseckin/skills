...
export async function handleOpenPulseTelemetry(params: {
  ...
  const pulseActor = typeof params.openPulse.actor === "string" ? params.openPulse.actor : params.actor;
  const pulseHost = typeof params.openPulse.host === "string" ? params.openPulse.host : params.host;
  const pulseDriver = typeof params.openPulse.driver === "string" ? params.openPulse.driver : params.driver;
  ...
  const wallClockToday =
    typeof params.budgetRecord.wall_clock_ms_today === "number" ? params.budgetRecord.wall_clock_ms_today : 0;
