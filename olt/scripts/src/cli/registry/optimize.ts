...
export const OPTIMIZE_COMMANDS: readonly CommandSpec[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      optionalFlag("logs", "string", "Alias for failure-logs."),
      optionalFlag(
        "clean-all",
        "bool",
        "Clean all active worktrees instead of only target plan worktrees.",
      ),
      optionalFlag("clean-all-worktrees", "bool", "Alias for clean-all."),
      ...
      optionalFlag("actor", "string", "Actor invoking quarantine."),
      optionalFlag("run", "string", "Capsule run directory or ID."),
    ],
    readsStdin: false,
    takesRemainder: false,
    exitCodes: DEFAULT_EXIT_CODES,
