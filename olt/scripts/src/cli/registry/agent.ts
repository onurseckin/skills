...
export const AGENT_COMMANDS: readonly CommandSpec[] = [
  {
    ...
    flags: [
      ...
      optionalFlag("pid", "int", "Explicit process ID for process ancestry binding."),
      optionalFlag("ppid", "int", "Explicit parent process ID for process ancestry binding."),
      toolFlag,
      toolExtraFlag,
    ],
    readsStdin: false,
  ...
  },
  {
    ...
    flags: [
      ...
      optionalFlag("host", "string", "Host runtime for the agent."),
