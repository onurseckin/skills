...
export const TASK_COMMANDS: readonly CommandSpec[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      optionalFlag(
        "defect",
        "string",
        "Identified defect category or description for micro-cycle.",
      ),
      optionalFlag(
        "max-rounds",
        "int",
        "Maximum micro-cycle rounds allowed before formal rejection.",
      ),
    ],
    readsStdin: false,
    takesRemainder: false,
  ...
  },
  {
    ...
    flags: [
      ...
      requiredFlag("task", "string", "Task under validation."),
      requiredFlag("validator", "string", "Validator agent id."),
      optionalFlag("token", "string", "Validation token. Required for formal rejection."),
      requiredFlag("reason", "string", "What is defective."),
      optionalFlag(
        "severity",
        "string",
        "critical, important or minor. Required for formal rejection.",
      ),
      optionalFlag(
        "remediation",
        "string",
