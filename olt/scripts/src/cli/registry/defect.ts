...
export const DEFECT_COMMANDS: readonly CommandSpec[] = [
  {
    ...
    flags: [
      ...
      optionalFlag("limit", "int", "Maximum entries to return."),
      optionalFlag("max-entries", "int", "Alias for --limit."),
      optionalFlag("max-occurrences", "int", "Maximum occurrences threshold."),
      optionalFlag(
        "strategy",
        "string",
        "Deduplication strategy (exact_dedup, windowed, sliding_window_hash, aggregate_synchronous).",
      ),
    ],
    readsStdin: false,
  ...
  },
  {
    ...
    flags: [
      ...
      optionalFlag("status", "string", "Filter by status."),
      optionalFlag("filter-status", "string", "Alias for --status."),
      optionalFlag("category", "string", "Filter by category."),
      optionalFlag("filter-category", "string", "Alias for --category."),
      optionalFlag("limit", "int", "Maximum entries to return."),
      optionalFlag("max-entries", "int", "Alias for --limit."),
    ],
    readsStdin: false,
