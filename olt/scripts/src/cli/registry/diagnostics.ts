...
export const DIAGNOSTICS_COMMANDS: readonly CommandSpec[] = [
  {
    ...
    flags: [
      ...
      optionalFlag(
        "auto-promote",
        "bool",
        "Automatically promote resolved defects to completed registry.",
      ),
      optionalFlag("promote", "string", "Promote a specific defect ID or 'all' resolved defects."),
      optionalFlag("generate-tests", "bool", "Generate regression test templates from defects."),
      optionalFlag(
        "output-tests",
        "string",
        "Output file path for generated regression test suite.",
      ),
      optionalFlag("completed-file", "string", "Destination file path for completed defects."),
      optionalFlag("dry-run", "bool", "Simulate defect promotion without writing to disk."),
    ],
    readsStdin: false,
  ...
  },
  {
    ...
    flags: [
      ...
      optionalFlag("actor", "string", "Acting persona identity."),
      optionalFlag("role", "string", "Acting supervisory role."),
    ],
    readsStdin: false,
    takesRemainder: false,
    exitCodes: DEFAULT_EXIT_CODES,
