...
export const MIND_COMMANDS_1: readonly CommandSpec[] = [
  mindCmd(
    ...
    [
      ...
      optionalFlag("format", "string", "Output format: json, table, or text."),
      optionalFlag("gen", "int", "Alias for generation filter."),
      optionalFlag("generation", "int", "Generation filter integer."),
      optionalFlag("json", "bool", "Output machine-readable JSON."),
      optionalFlag("pattern", "string", "Search pattern string."),
      optionalFlag("tag", "string", "Tag filter string."),
      optionalFlag("tags", "string", "Comma-separated tag filters."),
    ],
    memoryQueryCommand,
