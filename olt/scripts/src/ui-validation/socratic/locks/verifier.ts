 ...
 */
export function verifyAllMilestoneLocks(this: any): LockSystemIntegrityReport {
 ...
 */
export function assertIntegrity(this: any): void {
  ...
  if (!report.isAllValid) {
    throw new HarnessError(
      ...
      report.manifestResults.filter(
        (r: ManifestIntegrityResult) => r.tamperingDetected,
