export const DEFECT_ID = "defect-cli-1788680052899-2mhoq7";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: review check command C-b6ab4881-8ea5-49d5-92c3-a27f1f6144bd is not successful validator evidence for task-3";
