export const DEFECT_ID = "defect-cli-1788680177286-owj6gw";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: review check command C-1847d8dc-5413-44b6-b58d-ecd7b661f607 is not successful validator evidence for task-1";
