export const DEFECT_ID = "defect-cli-1788677715676-gb8gju";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: run is not ready for completeness critic: task task-1 lacks code-quality validator command evidence; task task-3 lacks code-quality validator command evidence; task task-4 lacks code-quality validator command evidence";
...
export function verifyDefectRemediation(
  ...
  const ctx = context ?? {
    ...
    gateCommand: "bun test tests/validation/defect-cli-1788677715676-gb8gju.test.ts",
    isUiTask: false,
