export const DEFECT_ID = "defect-cli-1788679313407-i432fe";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: task task-3 must be validated, validating, or gating before a gate command runs";
