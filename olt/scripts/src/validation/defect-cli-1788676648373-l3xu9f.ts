export const DEFECT_ID = "defect-cli-1788676648373-l3xu9f";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: task task-6 must be validated, validating, or gating before a gate command runs";
