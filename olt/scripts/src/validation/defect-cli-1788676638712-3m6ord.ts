export const DEFECT_ID = "defect-cli-1788676638712-3m6ord";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: task task-7 must be validated, validating, or gating before a gate command runs";
