export const DEFECT_ID = "defect-cli-1788678550003-promptfloor";
export const ERROR_CODE = "MISSING_PROMPT_BYTE_FLOOR";
export const DEFECT_TITLE =
  "Defect Remediation: plan:compile permits compiling an execution DAG against a prompt stub (e.g. 47 bytes) without enforcing a minimum prompt byte floor or verifying brief presence";
