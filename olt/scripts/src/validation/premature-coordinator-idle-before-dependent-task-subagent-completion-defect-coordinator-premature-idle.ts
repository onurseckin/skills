export const DEFECT_ID = "DEFECT-COORDINATOR-PREMATURE-IDLE";
export const ERROR_CODE = "COORDINATOR_PREMATURE_IDLE";
export const DEFECT_TITLE =
  "Defect Remediation: Premature Coordinator Idle Before Dependent Task/Subagent Completion";
