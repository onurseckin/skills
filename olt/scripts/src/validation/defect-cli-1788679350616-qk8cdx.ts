export const DEFECT_ID = "defect-cli-1788679350616-qk8cdx";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: task task-4 must be validated, validating, or gating before a gate command runs";
