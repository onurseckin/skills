export const DEFECT_ID = "defect-cli-1788678867094-svzw5u";
export const ERROR_CODE = "AUTHENTICATION_FAILURE";
export const DEFECT_TITLE =
  "Defect Remediation: Actor spoofing blocked: caller verified as 'orchestrator' (orchestrator) cannot execute as 'coordinator_interlocks'. Session tokens authenticate their holder and cannot delegate another agent's durable grant.";
...
export function verifyDefectRemediation(
  ...
  const ctx = context ?? {
    ...
    gateCommand: "bun test tests/validation/defect-cli-1788678867094-svzw5u.test.ts",
    isUiTask: false,
