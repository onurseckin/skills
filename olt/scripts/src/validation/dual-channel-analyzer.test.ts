...
describe("Static Invariant Verification: Zero TypeScript any & Zero Suppressions", () => {
  it("verifies dual-channel test and source files contain zero any and zero suppressions", () => {
    const filesToAudit = [
      "/Users/onurseckinsenoglu/repos/skills/olt/scripts/src/validation/dual-channel-types.ts",
      "/Users/onurseckinsenoglu/repos/skills/olt/scripts/src/validation/dual-channel-analyzer.ts",
      "/Users/onurseckinsenoglu/repos/skills/olt/scripts/src/validation/dual-channel-analyzer.test.ts",
    ];
