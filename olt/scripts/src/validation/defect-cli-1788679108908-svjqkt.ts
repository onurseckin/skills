export const DEFECT_ID = "defect-cli-1788679108908-svjqkt";
export const ERROR_CODE = "AUTHENTICATION_FAILURE";
export const DEFECT_TITLE =
  "Defect Remediation: Actor spoofing blocked: caller verified as 'coordinator_wave1' (coordinator) cannot execute as 'implementer_task3'. Session tokens authenticate their holder and cannot delegate another agent's durable grant.";
...
export function verifyDefectRemediation(
  ...
  const ctx = context ?? {
    ...
    gateCommand: "bun test tests/validation/defect-cli-1788679108908-svjqkt.test.ts",
    isUiTask: false,
