export const DEFECT_ID = "defect-cli-1788680033925-nq2dgb";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: review check command C-fb9de9ce-a869-4294-b3eb-ffa4513edfa9 is not successful validator evidence for task-2";
