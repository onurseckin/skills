export const DEFECT_ID = "defect-cli-1788677851247-4fb49r";
export const ERROR_CODE = "AUTHENTICATION_FAILURE";
export const DEFECT_TITLE =
  "Defect Remediation: Actor spoofing blocked: caller verified as 'completeness_critic' (completeness-critic) cannot execute as 'skill-auditor'. Session tokens authenticate their holder and cannot delegate another agent's durable grant.";
...
export function verifyDefectRemediation(
  ...
  const ctx = context ?? {
    ...
    gateCommand: "bun test tests/validation/defect-cli-1788677851247-4fb49r.test.ts",
    isUiTask: false,
