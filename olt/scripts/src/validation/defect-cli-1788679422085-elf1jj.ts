export const DEFECT_ID = "defect-cli-1788679422085-elf1jj";
export const ERROR_CODE = "AUTHENTICATION_FAILURE";
export const DEFECT_TITLE =
  "Defect Remediation: Actor spoofing blocked: caller verified as 'coordinator_interlocks' (coordinator) cannot execute as 'validator_validation'. Session tokens authenticate their holder and cannot delegate another agent's durable grant.";
...
export function verifyDefectRemediation(
  ...
  const ctx = context ?? {
    ...
    gateCommand: "bun test tests/validation/defect-cli-1788679422085-elf1jj.test.ts",
    isUiTask: false,
