export const DEFECT_ID = "defect-cli-1788682023885-2ur2o6";
export const ERROR_CODE = "INVALID_ARGUMENT";
export const DEFECT_TITLE =
  "Defect Remediation: [PERMISSION_DENIED] Command 'bun test tests/liaison' is prohibited for role 'completeness-critic'.";
