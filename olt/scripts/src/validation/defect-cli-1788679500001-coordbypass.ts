export const DEFECT_ID = "defect-cli-1788679500001-coordbypass";
export const ERROR_CODE = "ROLE_CONFINEMENT_BYPASS";
export const DEFECT_TITLE =
  "Defect Remediation: Harness permits coordinator to claim worker roles and execute production code and tests directly in a single conversation thread instead of mechanically enforcing invoke_subagent dispatch. Leads to severe context bloat and lease expiration.";
...
export function verifyDefectRemediation(
  ...
  const ctx = context ?? {
    ...
    gateCommand: "bun test tests/validation/defect-cli-1788679500001-coordbypass.test.ts",
    isUiTask: false,
