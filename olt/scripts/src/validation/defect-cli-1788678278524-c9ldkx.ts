export const DEFECT_ID = "defect-cli-1788678278524-c9ldkx";
export const ERROR_CODE = "AUTHENTICATION_FAILURE";
export const DEFECT_TITLE =
  "Defect Remediation: Actor spoofing blocked: caller verified as 'critic_wave2' (completeness-critic) cannot execute as 'coordinator_wave2'. Session tokens authenticate their holder and cannot delegate another agent's durable grant.";
...
export function verifyDefectRemediation(
  ...
  const ctx = context ?? {
    ...
    gateCommand: "bun test tests/validation/defect-cli-1788678278524-c9ldkx.test.ts",
    isUiTask: false,
