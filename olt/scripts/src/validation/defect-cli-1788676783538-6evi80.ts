export const DEFECT_ID = "defect-cli-1788676783538-6evi80";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: task task-5 must be validated, validating, or gating before a gate command runs";
