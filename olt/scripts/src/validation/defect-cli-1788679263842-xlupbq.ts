export const DEFECT_ID = "defect-cli-1788679263842-xlupbq";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: task task-1 must be validated, validating, or gating before a gate command runs";
