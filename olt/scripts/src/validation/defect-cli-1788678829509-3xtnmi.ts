export const DEFECT_ID = "defect-cli-1788678829509-3xtnmi";
export const ERROR_CODE = "AUTHENTICATION_FAILURE";
export const DEFECT_TITLE =
  "Defect Remediation: --actor is required to run 'plan:audit' but no verified caller identity is available; refusing to auto-fill it from an unauthenticated source (mechanisms: process_ancestry_pid_17435).";
...
export function verifyDefectRemediation(
  ...
  const ctx = context ?? {
    ...
    gateCommand: "bun test tests/validation/defect-cli-1788678829509-3xtnmi.test.ts",
    isUiTask: false,
