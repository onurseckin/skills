...
import { MIND_STRATEGIC_ALTITUDE } from "./strategic-purpose-chunk1.ts";
// import diagnoseMacroDag
import {
  diagnoseMacroDag,
...
import { synthesizeProactiveRoadmap } from "./strategic-purpose-chunk3.ts";
