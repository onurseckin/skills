export const DEFECT_ID = "defect-cli-20260906-001645-812";
export const ERROR_CODE = "INVALID_ARGUMENT";
export const DEFECT_TITLE =
  "Defect Remediation: task:review error hint suggests non-existent flag '--kind cognitive' for task:probe";
