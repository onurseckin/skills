...
export function verifyDefectRemediation(
  ...
  const fallbackContext: DefectRemediationContext = {
    actor: "implementer_task-22",
    role: "implementer",
    taskId: "task-22",
    state: "validating",
    sessionToken: "tok_live_defect_cli_1788679651683_1takfg",
    scope: ["olt/scripts/src/mind"],
    gateCommand: "bun test tests/mind/defect-cli-1788679651683-1takfg.test.ts",
    isUiTask: false,
