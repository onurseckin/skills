...
import { consolidateCapsules } from "./pruner.ts";
import { pruneCapsuleBoilerplate, isEffectivelyEmptyDirectory } from "./validator.ts";
export { isEffectivelyEmptyDirectory } from "./validator.ts";
