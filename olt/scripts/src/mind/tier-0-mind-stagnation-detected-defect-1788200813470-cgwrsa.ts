export const DEFECT_ID = "defect-1788200813470-cgwrsa";
export const ERROR_CODE = "LIVE_STAGNATION_DETECTED";
export const DEFECT_TITLE =
  "Defect Remediation: Tier 0 Mind Stagnation Detected - 1205s idle (threshold: 120s), Mode B wakeup injection synthesized";
export const RECORDED_IDLE_SECONDS = 1205;
