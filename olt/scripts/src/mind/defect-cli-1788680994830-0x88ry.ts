...
export const DEFECT_TITLE =
  "Defect Remediation: Actor spoofing blocked: caller verified as 'mind-gen-3' (mind) cannot execute as 'orchestrator_cross_communication'. Session tokens authenticate their holder and cannot delegate another agent's durable grant.";
