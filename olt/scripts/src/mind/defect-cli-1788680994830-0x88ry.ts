export const DEFECT_ID = "defect-cli-1788680994830-0x88ry";
...
export function verifyDefectRemediation(
  ...
  const fallbackContext: DefectRemediationContext = {
    actor: "implementer_task_1_42",
    role: "implementer",
    taskId: "task-1_42",
    state: "validating",
    sessionToken: "tok_live_defect_cli_1788680994830_0x88ry",
    scope: ["olt/scripts/src/mind"],
    gateCommand: "bun test tests/mind/defect-cli-1788680994830-0x88ry.test.ts",
    isUiTask: false,
