...
import { verifyDefectWitness } from "../../../witness.ts";
import { calculatePulseValue } from "../../../value.ts";
import type { WitnessVerificationCheckResult, PulseValueMetrics } from "./slice_20.ts";
