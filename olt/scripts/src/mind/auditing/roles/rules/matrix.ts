...
export type RoleBoundaryViolationType =
  ...
  | "coordinator_task_lease"
  | "orchestrator_direct_implementation"
  | "orchestrator_graph_mutation"
  | "orchestrator_task_implementation"
  | "unassigned_test_running"
  | "supervisory_test_execution"
  | "anti_boundary_leak"
  | "validator_code_writing"
...
export interface RoleBoundaryAuditResult {
  ...
  readonly actionsAuditedCount?: number | undefined;
  readonly summary?: string | undefined;
  readonly totalActions?: number | undefined;
  readonly violationsCount?: number | undefined;
