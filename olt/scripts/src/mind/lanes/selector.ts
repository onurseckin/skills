...
export type MindMode = "active" | "paused" | "halted" | "draining";
export type CharterStatus = "HEALTHY" | "DRIFTED" | "missing" | "unverified";
export type RuntimeStatus = "fresh" | "stale" | "missing";
export type IntegrityStatus = "PASSED" | "FAILED" | "repairable";

export type MindLaneDecision = LaneDecision;
