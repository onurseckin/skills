export const DEFECT_ID = "defect-cli-1788679827872-z0jknl";
...
export function verifyDefectRemediation(
  ...
  const fallbackContext: DefectRemediationContext = {
    actor: "implementer_task_1_28",
    role: "implementer",
    taskId: "task-1_28",
    state: "validating",
    sessionToken: "tok_live_defect_cli_1788679827872_z0jknl",
    scope: ["olt/scripts/src/mind"],
    gateCommand: "bun test tests/mind/defect-cli-1788679827872-z0jknl.test.ts",
    isUiTask: false,
