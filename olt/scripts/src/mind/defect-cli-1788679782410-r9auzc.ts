export const DEFECT_ID = "defect-cli-1788679782410-r9auzc";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE = "Defect Remediation: Cannot finalize review for task 'task-2': Cognitive deepening protocol not satisfied. Completed 1/5 required cognitive rounds. Run `task:probe --task task-2 --kind cognitive` to satisfy cognitive deepening.";
...
export function verifyDefectRemediation(
  ...
  const fallbackContext: DefectRemediationContext = {
    actor: "implementer_task_1_27",
    role: "implementer",
    taskId: "task-1_27",
    state: "validating",
    sessionToken: "tok_live_defect_cli_1788679782410_r9auzc",
    scope: ["olt/scripts/src/mind"],
    gateCommand: "bun test tests/mind/defect-cli-1788679782410-r9auzc.test.ts",
    isUiTask: false,
