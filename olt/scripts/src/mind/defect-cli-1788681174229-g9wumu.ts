export const DEFECT_ID = "defect-cli-1788681174229-g9wumu";
export const ERROR_CODE = "AUTHENTICATION_FAILURE";
export const DEFECT_TITLE = "Defect Remediation: Actor spoofing blocked: caller verified as 'mind-gen-3' (mind) cannot execute as 'orchestrator_cross_communication'. Session tokens authenticate their holder and cannot delegate another agent's durable grant.";
...
export function verifyDefectRemediation(
  ...
  const fallbackContext: DefectRemediationContext = {
    actor: "implementer_task_1_48",
    role: "implementer",
    taskId: "task-1_48",
    state: "validating",
    sessionToken: "tok_live_defect_cli_1788681174229_g9wumu",
    scope: ["olt/scripts/src/mind"],
    gateCommand: "bun test tests/mind/defect-cli-1788681174229-g9wumu.test.ts",
    isUiTask: false,
