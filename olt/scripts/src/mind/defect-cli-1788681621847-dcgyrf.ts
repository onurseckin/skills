export const DEFECT_ID = "defect-cli-1788681621847-dcgyrf";
export const ERROR_CODE = "AUTHENTICATION_FAILURE";
export const DEFECT_TITLE = "Defect Remediation: Actor spoofing blocked: caller verified as 'mind-gen-3' (mind) cannot execute as 'implementer_task-2'. Session tokens authenticate their holder and cannot delegate another agent's durable grant.";
...
export function verifyDefectRemediation(
  ...
  const fallbackContext: DefectRemediationContext = {
    actor: "implementer_task_1_51",
    role: "implementer",
    taskId: "task-1_51",
    state: "validating",
    sessionToken: "tok_live_defect_cli_1788681621847_dcgyrf",
    scope: ["olt/scripts/src/mind"],
    gateCommand: "bun test tests/mind/defect-cli-1788681621847-dcgyrf.test.ts",
    isUiTask: false,
