export const DEFECT_ID = "defect-1788198297389-0jpptb";
export const ERROR_CODE = "LIVE_STAGNATION_DETECTED";
export const DEFECT_TITLE =
  "Defect Remediation: Tier 0 Mind Stagnation Detected - 1217s idle (threshold: 120s), Mode B wakeup injection synthesized";
export const RECORDED_IDLE_SECONDS = 1217;
