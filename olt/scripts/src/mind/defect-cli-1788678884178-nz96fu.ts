export const DEFECT_ID = "defect-cli-1788678884178-nz96fu";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE =
  "Defect Remediation: plan:brainstorm could not load capsule state at --run supervisory-cadence-and-mechanical-interlocks and is not on the grant bootstrap allowlist for missing capsules; an unreadable capsule cannot be treated as one with no grants";
...
export function verifyDefectRemediation(
  ...
  const fallbackContext: DefectRemediationContext = {
    actor: "implementer_task-17",
    role: "implementer",
    taskId: "task-17",
    state: "validating",
    sessionToken: "tok_live_defect_cli_1788678884178_nz96fu",
    scope: ["olt/scripts/src/mind"],
    gateCommand: "bun test tests/mind/defect-cli-1788678884178-nz96fu.test.ts",
    isUiTask: false,
