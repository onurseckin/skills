export const DEFECT_ID = "defect-cli-1788679090623-dnv62h";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE = "Defect Remediation: agent implementer_cadence already holds a grant in this run";
