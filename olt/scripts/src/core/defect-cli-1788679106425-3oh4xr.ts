export const DEFECT_ID = "defect-cli-1788679106425-3oh4xr";
export const ERROR_CODE = "INVALID_STATE";
export const DEFECT_TITLE = "Defect Remediation: agent implementer_guard already holds a grant in this run";
