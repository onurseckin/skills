...
import { createSampleStragglerTask } from "./fixture.ts";
import { STRAGGLERS_SUITES } from "./index.ts";
...
describe("Domain 20: 5-Minute Straggler SLA Partitioning", () => {
  ...
  test("stragglers fixture and suite registry are valid", () => {
