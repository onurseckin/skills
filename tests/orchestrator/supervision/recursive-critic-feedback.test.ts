...
import type { TaskRepairSummary } from "../../../olt/scripts/src/workflow/completion/index.ts";
import type { CompletionReview } from "../../../olt/scripts/src/workflow/completion/index.ts";
import type { TaskRecord } from "../../../olt/scripts/src/workflow/types.ts";
import { TestPort, repositoryBinding, workflowState } from "../../workflow/shared/test-port.ts";
...
describe("Orchestrator Recursive Critic Feedback Integration", () => {
      ...
      findings: [
        {
          ...
          revalidation: "bun test tests/db/db.test.ts",
          status: "open",
        },
      ],
  ...
  test("processCriticFeedbackLoop generates structured repair instructions and defect synthesis", () => {
    ...
    if (instruction) {
      ...
      expect(instruction.revalidationGates).toContain("bun test tests/db/db.test.ts");
    }
