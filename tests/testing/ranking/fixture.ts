...
export function createSampleRuntimeSummary(overrides: Partial<TestRuntimeSummary> = {}): TestRuntimeSummary {
  return {
    totalFiles: 2,
    totalDurationMs: 150,
    avgDurationMs: 75,
    ...
    slowestFile: { file: "tests/testing/runner/test-runner.test.ts", durationMs: 100, passed: true },
    pareto50FileCount: 1,
    pareto90FileCount: 2,
    ...overrides,
  };
