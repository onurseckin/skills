 ...
 * Spies for open file descriptors, truncation, flock, and file-descriptor level ops.
 */
...
export function createDescriptorSpies(s: VirtualStoreState): Array<{ mockRestore: () => void }> {
