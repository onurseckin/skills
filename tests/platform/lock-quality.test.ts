...
import { linuxLibcCandidates, tryExclusiveFlock } from "../../orchestrating-long-tasks/scripts/src/platform/flock-ffi.ts";
import { withRunLock } from "../../orchestrating-long-tasks/scripts/src/platform/run-lock.ts";

const lockModule = new URL("../../orchestrating-long-tasks/scripts/src/platform/run-lock.ts", import.meta.url).pathname;
