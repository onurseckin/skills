...
} from "../../olt/scripts/src/mind/defect-cli-1788681000629-7vhasl.ts";

describe("Defect Remediation: defect-cli-1788681000629-7vhasl", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681000629-7vhasl");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788681000629-7vhasl.ts"],
