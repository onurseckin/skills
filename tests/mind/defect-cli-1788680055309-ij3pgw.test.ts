...
} from "../../olt/scripts/src/mind/defect-cli-1788680055309-ij3pgw.ts";

describe("Defect Remediation: defect-cli-1788680055309-ij3pgw", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680055309-ij3pgw");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_36",
      role: "implementer",
      taskId: "task-1_36",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788680055309_ij3pgw",
      scope: ["olt/scripts/src/mind/defect-cli-1788680055309-ij3pgw.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788680055309-ij3pgw.test.ts",
    };
