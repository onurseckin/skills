...
} from "../../olt/scripts/src/mind/defect-cli-1788679863419-vu2inm.ts";

describe("Defect Remediation: defect-cli-1788679863419-vu2inm", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679863419-vu2inm");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788679863419-vu2inm.ts"],
