...
} from "../../olt/scripts/src/mind/defect-cli-1788681764942-4uw80l.ts";

describe("Defect Remediation: defect-cli-1788681764942-4uw80l", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681764942-4uw80l");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_52",
      role: "implementer",
      taskId: "task-1_52",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788681764942_4uw80l",
      scope: ["olt/scripts/src/mind/defect-cli-1788681764942-4uw80l.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788681764942-4uw80l.test.ts",
    };
