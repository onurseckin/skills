...
} from "../../olt/scripts/src/mind/defect-cli-1788680946534-9sf7id.ts";

describe("Defect Remediation: defect-cli-1788680946534-9sf7id", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680946534-9sf7id");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788680946534-9sf7id.ts"],
