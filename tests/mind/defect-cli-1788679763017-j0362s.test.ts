...
} from "../../olt/scripts/src/mind/defect-cli-1788679763017-j0362s.ts";

describe("Defect Remediation: defect-cli-1788679763017-j0362s", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679763017-j0362s");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_26",
      role: "implementer",
      taskId: "task-1_26",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788679763017_j0362s",
      scope: ["olt/scripts/src/mind/defect-cli-1788679763017-j0362s.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788679763017-j0362s.test.ts",
    };
