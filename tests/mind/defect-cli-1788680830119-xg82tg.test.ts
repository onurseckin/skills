...
} from "../../olt/scripts/src/mind/defect-cli-1788680830119-xg82tg.ts";

describe("Defect Remediation: defect-cli-1788680830119-xg82tg", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680830119-xg82tg");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_39",
      role: "implementer",
      taskId: "task-1_39",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788680830119_xg82tg",
      scope: ["olt/scripts/src/mind/defect-cli-1788680830119-xg82tg.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788680830119-xg82tg.test.ts",
    };
