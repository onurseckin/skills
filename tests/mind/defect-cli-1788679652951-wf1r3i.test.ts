...
} from "../../olt/scripts/src/mind/defect-cli-1788679652951-wf1r3i.ts";

describe("Defect Remediation: defect-cli-1788679652951-wf1r3i", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679652951-wf1r3i");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788679652951-wf1r3i.ts"],
