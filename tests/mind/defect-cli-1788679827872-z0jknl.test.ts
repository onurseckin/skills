...
} from "../../olt/scripts/src/mind/defect-cli-1788679827872-z0jknl.ts";

describe("Defect Remediation: defect-cli-1788679827872-z0jknl", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679827872-z0jknl");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788679827872-z0jknl.ts"],
