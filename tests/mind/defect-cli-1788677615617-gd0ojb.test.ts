...
} from "../../olt/scripts/src/mind/defect-cli-1788677615617-gd0ojb.ts";

describe("Defect Remediation: defect-cli-1788677615617-gd0ojb", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677615617-gd0ojb");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_10",
      role: "implementer",
      taskId: "task-1_10",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788677615617_gd0ojb",
      scope: ["olt/scripts/src/mind/defect-cli-1788677615617-gd0ojb.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788677615617-gd0ojb.test.ts",
    };
