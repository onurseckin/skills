...
} from "../../olt/scripts/src/mind/defect-cli-1788682453430-eafj29.ts";

describe("Defect Remediation: defect-cli-1788682453430-eafj29", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682453430-eafj29");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_56",
      role: "implementer",
      taskId: "task-1_56",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788682453430_eafj29",
      scope: ["olt/scripts/src/mind/defect-cli-1788682453430-eafj29.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788682453430-eafj29.test.ts",
    };
