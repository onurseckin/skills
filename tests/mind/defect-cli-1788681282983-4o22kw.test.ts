...
} from "../../olt/scripts/src/mind/defect-cli-1788681282983-4o22kw.ts";

describe("Defect Remediation: defect-cli-1788681282983-4o22kw", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681282983-4o22kw");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_49",
      role: "implementer",
      taskId: "task-1_49",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788681282983_4o22kw",
      scope: ["olt/scripts/src/mind/defect-cli-1788681282983-4o22kw.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788681282983-4o22kw.test.ts",
    };
