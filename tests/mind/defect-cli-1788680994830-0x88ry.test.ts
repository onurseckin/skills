...
} from "../../olt/scripts/src/mind/defect-cli-1788680994830-0x88ry.ts";

describe("Defect Remediation: defect-cli-1788680994830-0x88ry", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680994830-0x88ry");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788680994830-0x88ry.ts"],
