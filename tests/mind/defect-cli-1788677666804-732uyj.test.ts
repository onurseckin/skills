...
} from "../../olt/scripts/src/mind/defect-cli-1788677666804-732uyj.ts";

describe("Defect Remediation: defect-cli-1788677666804-732uyj", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677666804-732uyj");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_11",
      role: "implementer",
      taskId: "task-1_11",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788677666804_732uyj",
      scope: ["olt/scripts/src/mind/defect-cli-1788677666804-732uyj.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788677666804-732uyj.test.ts",
    };
