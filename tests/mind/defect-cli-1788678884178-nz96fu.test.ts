...
} from "../../olt/scripts/src/mind/defect-cli-1788678884178-nz96fu.ts";

describe("Defect Remediation: defect-cli-1788678884178-nz96fu", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678884178-nz96fu");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788678884178-nz96fu.ts"],
