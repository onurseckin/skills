...
} from "../../olt/scripts/src/mind/defect-cli-1788682333451-hf2nr0.ts";

describe("Defect Remediation: defect-cli-1788682333451-hf2nr0", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682333451-hf2nr0");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_55",
      role: "implementer",
      taskId: "task-1_55",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788682333451_hf2nr0",
      scope: ["olt/scripts/src/mind/defect-cli-1788682333451-hf2nr0.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788682333451-hf2nr0.test.ts",
    };
