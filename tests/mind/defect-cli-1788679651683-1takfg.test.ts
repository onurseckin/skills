...
} from "../../olt/scripts/src/mind/defect-cli-1788679651683-1takfg.ts";

describe("Defect Remediation: defect-cli-1788679651683-1takfg", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679651683-1takfg");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788679651683-1takfg.ts"],
