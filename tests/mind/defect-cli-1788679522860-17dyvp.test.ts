...
} from "../../olt/scripts/src/mind/defect-cli-1788679522860-17dyvp.ts";

describe("Defect Remediation: defect-cli-1788679522860-17dyvp", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679522860-17dyvp");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task-21",
      role: "implementer",
      taskId: "task-21",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788679522860_17dyvp",
      scope: ["olt/scripts/src/mind/defect-cli-1788679522860-17dyvp.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788679522860-17dyvp.test.ts",
    };
