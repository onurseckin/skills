...
} from "../../olt/scripts/src/mind/defect-cli-1788680211751-mywuyu.ts";

describe("Defect Remediation: defect-cli-1788680211751-mywuyu", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680211751-mywuyu");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_38",
      role: "implementer",
      taskId: "task-1_38",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788680211751_mywuyu",
      scope: ["olt/scripts/src/mind/defect-cli-1788680211751-mywuyu.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788680211751-mywuyu.test.ts",
    };
