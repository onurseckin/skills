...
} from "../../olt/scripts/src/mind/defect-cli-1788682558262-udjmq8.ts";

describe("Defect Remediation: defect-cli-1788682558262-udjmq8", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682558262-udjmq8");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_57",
      role: "implementer",
      taskId: "task-1_57",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788682558262_udjmq8",
      scope: ["olt/scripts/src/mind/defect-cli-1788682558262-udjmq8.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788682558262-udjmq8.test.ts",
    };
