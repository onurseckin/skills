...
} from "../../olt/scripts/src/mind/defect-cli-1788678839434-1w1z76.ts";

describe("Defect Remediation: defect-cli-1788678839434-1w1z76", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678839434-1w1z76");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_15",
      role: "implementer",
      taskId: "task-1_15",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788678839434_1w1z76",
      scope: ["olt/scripts/src/mind/defect-cli-1788678839434-1w1z76.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788678839434-1w1z76.test.ts",
    };
