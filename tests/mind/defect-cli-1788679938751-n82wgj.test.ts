...
} from "../../olt/scripts/src/mind/defect-cli-1788679938751-n82wgj.ts";

describe("Defect Remediation: defect-cli-1788679938751-n82wgj", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679938751-n82wgj");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788679938751-n82wgj.ts"],
