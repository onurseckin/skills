...
} from "../../olt/scripts/src/mind/defect-cli-1788679982455-lmerue.ts";

describe("Defect Remediation: defect-cli-1788679982455-lmerue", () => {
  test("exports expected defect metadata and required cognitive round constants", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679982455-lmerue");
    expect(ERROR_CODE).toBe("INVALID_STATE");
    expect(DEFECT_TITLE).toContain("task-2");
