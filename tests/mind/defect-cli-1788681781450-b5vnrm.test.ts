...
} from "../../olt/scripts/src/mind/defect-cli-1788681781450-b5vnrm.ts";

describe("Defect Remediation: defect-cli-1788681781450-b5vnrm", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681781450-b5vnrm");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788681781450-b5vnrm.ts"],
