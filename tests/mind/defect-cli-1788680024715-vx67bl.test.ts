...
} from "../../olt/scripts/src/mind/defect-cli-1788680024715-vx67bl.ts";

describe("Defect Remediation: defect-cli-1788680024715-vx67bl", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680024715-vx67bl");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788680024715-vx67bl.ts"],
