...
} from "../../olt/scripts/src/mind/cognitive-adversarial-validation-push-disregard-in-task-review-defect-validation-push-bypass.ts";

describe("Defect Remediation: DEFECT-VALIDATION-PUSH-BYPASS", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("DEFECT-VALIDATION-PUSH-BYPASS");
    expect(ERROR_CODE).toBe("VALIDATION_PUSH_DISREGARD");
