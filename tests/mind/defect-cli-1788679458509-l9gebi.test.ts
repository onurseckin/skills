...
} from "../../olt/scripts/src/mind/defect-cli-1788679458509-l9gebi.ts";

describe("Defect Remediation: defect-cli-1788679458509-l9gebi", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679458509-l9gebi");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task-20",
      role: "implementer",
      taskId: "task-20",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788679458509_l9gebi",
      scope: ["olt/scripts/src/mind/defect-cli-1788679458509-l9gebi.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788679458509-l9gebi.test.ts",
    };
