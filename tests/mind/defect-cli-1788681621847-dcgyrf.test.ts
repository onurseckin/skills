...
} from "../../olt/scripts/src/mind/defect-cli-1788681621847-dcgyrf.ts";

describe("Defect Remediation: defect-cli-1788681621847-dcgyrf", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681621847-dcgyrf");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788681621847-dcgyrf.ts"],
