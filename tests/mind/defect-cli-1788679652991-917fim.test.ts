...
} from "../../olt/scripts/src/mind/defect-cli-1788679652991-917fim.ts";

describe("Defect Remediation: defect-cli-1788679652991-917fim", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679652991-917fim");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_25",
      role: "implementer",
      taskId: "task-1_25",
      state: "validating",
      sessionToken: "tok_live_defect_cli_1788679652991_917fim",
      scope: ["olt/scripts/src/mind/defect-cli-1788679652991-917fim.ts"],
      gateCommand: "bun test tests/mind/defect-cli-1788679652991-917fim.test.ts",
    };
