...
} from "../../olt/scripts/src/mind/defect-cli-1788679782410-r9auzc.ts";

describe("Defect Remediation: defect-cli-1788679782410-r9auzc", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679782410-r9auzc");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788679782410-r9auzc.ts"],
