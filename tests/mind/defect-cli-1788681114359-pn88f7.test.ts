...
} from "../../olt/scripts/src/mind/defect-cli-1788681114359-pn88f7.ts";

describe("Defect Remediation: defect-cli-1788681114359-pn88f7", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681114359-pn88f7");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788681114359-pn88f7.ts"],
