...
} from "../../olt/scripts/src/mind/defect-cli-1788680091033-0oztuq.ts";

describe("Defect Remediation: defect-cli-1788680091033-0oztuq", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680091033-0oztuq");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/mind/defect-cli-1788680091033-0oztuq.ts"],
