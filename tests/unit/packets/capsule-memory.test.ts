...
import {
  ...
  writeDecoupledBlob,
} from "../../../orchestrating-long-tasks/scripts/src/packets/capsule-memory.ts";
    ...
    test("validates a properly constructed implementer packet", () => {
      ...
      const packet = buildPacket({
        ...
        authoritativeContext: {
          ...inspectionContext(),
          mapped_requirements: [{ id: "R-1", text: "Requirement" }],
          task_contract: { id: "T-1", write_scope: ["src/app.ts"] },
        },
      });
