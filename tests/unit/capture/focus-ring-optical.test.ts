  ...
  describe("6. Static Invariant Verification: Zero TypeScript any & Zero Suppressions", () => {
    it("verifies zero TypeScript any and zero compiler/linter suppressions across touched mechanical validator files", () => {
      const filesToAudit = [
        ...
        resolve(
          import.meta.dir,
          "../../../olt/scripts/src/capture/validator/mechanical/concentric-radius.ts",
        ),
        resolve(
          import.meta.dir,
          "../../../olt/scripts/src/capture/validator/mechanical/subpixel-snapping.ts",
        ),
        resolve(import.meta.dir, "../../../olt/scripts/src/capture/validator/mechanical/apca.ts"),
        resolve(import.meta.dir, "../../../olt/scripts/src/capture/validator/mechanical/index.ts"),
      ];
