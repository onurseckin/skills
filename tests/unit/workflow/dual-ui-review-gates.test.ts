    ...
    it("formats passing dual UI validation report", () => {
      const mockResult: DualUiAuditResult = {
        ...
        mechanicReport: {
          ...
          missingViewports: [],
          touchTargetEvaluations: [{ selector: "button", width: 48, height: 48, passed: true, minRequired: 44 }],
          touchTargetFailures: [],
          overflowEvaluations: [],
          overflowViolations: [],
          journeyResults: [],
        ...
        cognitiveReport: {
          passed: true,
          canExecuteShell: false,
          opticalHierarchy: { score: 100, passed: true, headingScaleRatio: 1.25, visualWeightBalanced: true, notes: "ok", issues: [] },
          descenderIntegrity: { passed: true, clippedElements: [], elementsInspected: 1, descenderCharactersChecked: ["g", "j"], notes: "ok", issues: [] },
          aestheticHarmony: { score: 100, passed: true, spacingRhythmGrid: 8, spacingRhythmValid: true, colorPaletteBalance: "ok", themeHarmony: "dark", notes: "ok", issues: [] },
    ...
    it("formats failing report highlighting defect categories", () => {
      const failingResult: DualUiAuditResult = {
        ...
        mechanicReport: {
          ...
          touchTargetEvaluations: [{ selector: "button.tiny", width: 30, height: 30, passed: false, minRequired: 44 }],
          touchTargetFailures: [{ selector: "button.tiny", width: 30, height: 30, passed: false, minRequired: 44 }],
          overflowEvaluations: [],
          overflowViolations: [],
          journeyResults: [],
        ...
        cognitiveReport: {
          passed: false,
          canExecuteShell: false,
          opticalHierarchy: { score: 50, passed: false, headingScaleRatio: 1.0, visualWeightBalanced: false, notes: "inverted", issues: ["Inverted scale"] },
          descenderIntegrity: { passed: true, clippedElements: [], elementsInspected: 0, descenderCharactersChecked: [], notes: "ok", issues: [] },
          aestheticHarmony: { score: 60, passed: false, spacingRhythmGrid: 4, spacingRhythmValid: false, colorPaletteBalance: "bad", themeHarmony: "inconsistent", notes: "bad", issues: ["Irregular margin"] },
        ...
        defects: [
          { id: "d-1", pillar: "mechanical", category: "touch-hitbox", message: "Button below 44pt", severity: "important", remediation: "Increase size" },
          { id: "d-2", pillar: "cognitive", category: "optical-hierarchy", message: "Inverted scale", severity: "important", remediation: "Fix scale" },
        ],
