...
import { LiveDefectDeduplicator } from "../../../olt/scripts/src/defects/live-dedup.ts";
...
describe("LiveDefectDeduplicator Engine", () => {
  ...
  test("resolves defects with resolution proof", () => {
    const dedup = new LiveDefectDeduplicator();
    ...
    const resolved = dedup.resolve("defect-res-target", {
