...
} from "../../../olt/scripts/src/mind/tier-0-mind-stagnation-detected-defect-1788198297389-0jpptb.ts";

describe("Defect Remediation: defect-1788198297389-0jpptb", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-1788198297389-0jpptb");
    expect(ERROR_CODE).toBe("LIVE_STAGNATION_DETECTED");
    expect(DEFECT_TITLE).toContain("Tier 0 Mind Stagnation Detected");
    expect(RECORDED_IDLE_SECONDS).toBe(1217);
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_task_1_2",
      role: "implementer",
      taskId: "task-1_2",
      state: "validating",
      sessionToken: "tok_live_defect_1788198297389_0jpptb",
      scope: ["olt/scripts/src/mind/tier-0-mind-stagnation-detected-defect-1788198297389-0jpptb.ts"],
      gateCommand:
        "bun test tests/unit/mind/tier-0-mind-stagnation-detected-defect-1788198297389-0jpptb.test.ts",
