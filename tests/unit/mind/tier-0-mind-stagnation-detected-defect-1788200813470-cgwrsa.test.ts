...
} from "../../../olt/scripts/src/mind/tier-0-mind-stagnation-detected-defect-1788200813470-cgwrsa.ts";

describe("Defect Remediation: defect-1788200813470-cgwrsa", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-1788200813470-cgwrsa");
    expect(ERROR_CODE).toBe("LIVE_STAGNATION_DETECTED");
    expect(DEFECT_TITLE).toContain("Tier 0 Mind Stagnation Detected");
    expect(RECORDED_IDLE_SECONDS).toBe(1205);
