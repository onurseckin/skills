...
describe("Static Invariant Verification: Zero TypeScript any & Zero Suppressions", () => {
  it("verifies task review dual channel test and support files contain zero any and zero suppressions", () => {
    const filesToAudit = [
      join(import.meta.dir, "../../../olt/scripts/src/cli/commands/task-review-support.ts"),
      join(import.meta.dir, "../../../olt/scripts/src/cli/commands/task-review.ts"),
      join(import.meta.dir, "../../../olt/scripts/src/cli/commands/critic-ops.ts"),
      join(import.meta.dir, "task-review-dual-channel.test.ts"),
    ];
