...
const FALLBACK_CEILING: ReadonlyMap<string, number> = new Map([
  ...
  ["olt/scripts/src/mind/preplanning/backlog-clusterer.ts", 3],
  ...
  ["olt/scripts/src/mind/tasks/discovery/discovery-scans.ts", 1],
  ...
  ["olt/scripts/src/mind/tasks/smart/executor/evolution.ts", 1],
  ...
  ["olt/scripts/src/reporting/sugiyama-dag/render-box.ts", 3],
