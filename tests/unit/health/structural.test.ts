...
const FALLBACK_CEILING: ReadonlyMap<string, number> = new Map([
  ...
  ["olt/scripts/src/authority/watchdog-manager.ts", 2],
  ...
  ["olt/scripts/src/doctor/tier-confinement.ts", 2],
  ...
  ["olt/scripts/src/mind/smart-task-manager.ts", 9],
  ...
  ["olt/scripts/src/platform/chatgpt.ts", 3],
  ["olt/scripts/src/platform/claude-code.ts", 5],
  ["olt/scripts/src/platform/codex.ts", 6],
  ["olt/scripts/src/platform/cursor.ts", 3],
  ["olt/scripts/src/platform/unfulfilled-demand.ts", 2],
  ...
  ["olt/scripts/src/scheduler/core-engine.ts", 2],
  ["olt/scripts/src/scheduler/dynamic-topology.ts", 1],
  ["olt/scripts/src/summary/asset-mapper.ts", 1],
  ["olt/scripts/src/summary/graph-generator-critic-nodes.ts", 1],
  ["olt/scripts/src/summary/metrics-collector-helpers.ts", 7],
  ["olt/scripts/src/summary/metrics-collector.ts", 2],
  ...
  ["olt/scripts/src/worktree/domain-sync.ts", 1],
]);
