...
const FALLBACK_CEILING: ReadonlyMap<string, number> = new Map([
  ...
  ["orchestrating-long-tasks/scripts/src/doctor/tier-confinement.ts", 2],
  ["orchestrating-long-tasks/scripts/src/graph/dag-expansion.ts", 1],
  ["orchestrating-long-tasks/scripts/src/installer/tree-digest.ts", 1],
  ["orchestrating-long-tasks/scripts/src/mind/audit.ts", 4],
  ["orchestrating-long-tasks/scripts/src/mind/blunders.ts", 6],
  ...
  ["orchestrating-long-tasks/scripts/src/mind/liveness.ts", 3],
  ["orchestrating-long-tasks/scripts/src/mind/mind.ts", 2],
  ["orchestrating-long-tasks/scripts/src/mind/proposal.ts", 5],
  ...
  ["orchestrating-long-tasks/scripts/src/mind/role-auditing.ts", 5],
  ...
  ["orchestrating-long-tasks/scripts/src/platform/chatgpt.ts", 3],
  ["orchestrating-long-tasks/scripts/src/platform/claude-code.ts", 5],
  ["orchestrating-long-tasks/scripts/src/platform/codex.ts", 6],
  ["orchestrating-long-tasks/scripts/src/platform/cursor.ts", 3],
  ["orchestrating-long-tasks/scripts/src/platform/unfulfilled-demand.ts", 2],
