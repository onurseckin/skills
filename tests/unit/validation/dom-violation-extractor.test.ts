...
import { extractDomViolations } from "../../../olt/scripts/src/validation/dom-violation-extractor.ts";
import type { VisualMetricsReport } from "../../../olt/scripts/src/validation/dual-channel-types.ts";
