 ...
 * Spies for open descriptors, truncation, fstat, and platform flock for watchdog domain.
 */
...
export function createDescriptorSpies(s: VirtualWatchdogState): Array<{ mockRestore: () => void }> {
