...
//
// The CLI-driven, real-capsule cases for this behavior ("CLI: --summary is required" and
// "critic:review persists the summary onto completion_review.summary") live in
// tests/workflow/completion/provenance/completion-review-summary.test.ts; this file keeps the in-memory
// domain-level cases only.
