...
const setupTestCapsule = async (): Promise<{
  ...
  const testDir = mkdtempSync(join(tmpdir(), "test-dual-chan-verdicts-"));
  roots.push(testDir);
...
describe("task:review & critic:review Verdicts & Rubber-Stamp Rejections", () => {
  ...
  it("taskReviewCommand rejects rubber-stamp and generic sign-off summaries with INVALID_ARGUMENT", async () => {
    ...
    const genericSummaries = [
      "looks good", "lgtm", "all good", "passed", "pass", "ok", "fine", "done",
      "approved", "verified", "no issues", "all tests pass", "rubber stamp", "n/a", "none", "short",
    ];
  ...
  it("criticReviewCommand rejects rubber-stamp and generic sign-off summaries with INVALID_ARGUMENT", async () => {
    ...
    const genericSummaries = [
      "looks good", "lgtm", "all good", "approved", "approve", "done", "ok", "fine",
      "pass", "passed", "everything passed", "all requirements met", "verified",
      "rubber stamp", "n/a", "none", "short string",
    ];
