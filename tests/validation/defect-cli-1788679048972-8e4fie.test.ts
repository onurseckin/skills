...
} from "../../olt/scripts/src/validation/defect-cli-1788679048972-8e4fie.ts";

describe("Defect Remediation: defect-cli-1788679048972-8e4fie", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679048972-8e4fie");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679048972-8e4fie.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679048972-8e4fie.test.ts",
    };
