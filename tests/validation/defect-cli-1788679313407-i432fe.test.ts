...
} from "../../olt/scripts/src/validation/defect-cli-1788679313407-i432fe.ts";

describe("Defect Remediation: defect-cli-1788679313407-i432fe", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679313407-i432fe");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679313407-i432fe.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679313407-i432fe.test.ts",
    };
