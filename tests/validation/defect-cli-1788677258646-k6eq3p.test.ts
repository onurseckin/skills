...
} from "../../olt/scripts/src/validation/defect-cli-1788677258646-k6eq3p.ts";

describe("Defect Remediation: defect-cli-1788677258646-k6eq3p", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677258646-k6eq3p");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788677258646-k6eq3p.ts"],
