...
} from "../../olt/scripts/src/validation/defect-cli-1788676928020-ef9h67.ts";

describe("Defect Remediation: defect-cli-1788676928020-ef9h67", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676928020-ef9h67");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788676928020-ef9h67.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788676928020-ef9h67.test.ts",
    };
