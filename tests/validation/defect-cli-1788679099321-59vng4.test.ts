...
} from "../../olt/scripts/src/validation/defect-cli-1788679099321-59vng4.ts";

describe("Defect Remediation: defect-cli-1788679099321-59vng4", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679099321-59vng4");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679099321-59vng4.ts"],
