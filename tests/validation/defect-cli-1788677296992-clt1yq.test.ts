...
} from "../../olt/scripts/src/validation/defect-cli-1788677296992-clt1yq.ts";

describe("Defect Remediation: defect-cli-1788677296992-clt1yq", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677296992-clt1yq");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788677296992-clt1yq.ts"],
