...
} from "../../olt/scripts/src/validation/defect-cli-1788681802268-6yykuq.ts";

describe("Defect Remediation: defect-cli-1788681802268-6yykuq", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681802268-6yykuq");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788681802268-6yykuq.ts"],
