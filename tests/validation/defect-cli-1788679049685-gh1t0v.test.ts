...
} from "../../olt/scripts/src/validation/defect-cli-1788679049685-gh1t0v.ts";

describe("Defect Remediation: defect-cli-1788679049685-gh1t0v", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679049685-gh1t0v");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679049685-gh1t0v.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679049685-gh1t0v.test.ts",
    };
