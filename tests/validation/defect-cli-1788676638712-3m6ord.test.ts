...
} from "../../olt/scripts/src/validation/defect-cli-1788676638712-3m6ord.ts";

describe("Defect Remediation: defect-cli-1788676638712-3m6ord", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676638712-3m6ord");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788676638712-3m6ord.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788676638712-3m6ord.test.ts",
    };
