...
} from "../../olt/scripts/src/validation/defect-cli-1788679364101-sh0kdu.ts";

describe("Defect Remediation: defect-cli-1788679364101-sh0kdu", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679364101-sh0kdu");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679364101-sh0kdu.ts"],
