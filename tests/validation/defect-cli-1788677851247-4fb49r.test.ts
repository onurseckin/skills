...
} from "../../olt/scripts/src/validation/defect-cli-1788677851247-4fb49r.ts";

describe("Defect Remediation: defect-cli-1788677851247-4fb49r", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677851247-4fb49r");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788677851247-4fb49r.ts"],
