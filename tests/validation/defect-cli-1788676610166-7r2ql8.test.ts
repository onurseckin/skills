...
} from "../../olt/scripts/src/validation/defect-cli-1788676610166-7r2ql8.ts";

describe("Defect Remediation: defect-cli-1788676610166-7r2ql8", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676610166-7r2ql8");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788676610166-7r2ql8.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788676610166-7r2ql8.test.ts",
    };
