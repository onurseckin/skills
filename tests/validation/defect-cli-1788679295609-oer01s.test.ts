...
} from "../../olt/scripts/src/validation/defect-cli-1788679295609-oer01s.ts";

describe("Defect Remediation: defect-cli-1788679295609-oer01s", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679295609-oer01s");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679295609-oer01s.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679295609-oer01s.test.ts",
    };
