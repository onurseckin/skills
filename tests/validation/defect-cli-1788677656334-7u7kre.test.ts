...
} from "../../olt/scripts/src/validation/defect-cli-1788677656334-7u7kre.ts";

describe("Defect Remediation: defect-cli-1788677656334-7u7kre", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677656334-7u7kre");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788677656334-7u7kre.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788677656334-7u7kre.test.ts",
    };
