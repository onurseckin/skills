...
} from "../../olt/scripts/src/validation/defect-cli-1788679808859-ovcs1t.ts";

describe("Defect Remediation: defect-cli-1788679808859-ovcs1t", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679808859-ovcs1t");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679808859-ovcs1t.ts"],
