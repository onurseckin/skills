...
} from "../../olt/scripts/src/validation/defect-cli-1788679052934-cbdqyo.ts";

describe("Defect Remediation: defect-cli-1788679052934-cbdqyo", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679052934-cbdqyo");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679052934-cbdqyo.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679052934-cbdqyo.test.ts",
    };
