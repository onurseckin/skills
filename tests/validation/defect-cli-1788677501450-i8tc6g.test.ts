...
} from "../../olt/scripts/src/validation/defect-cli-1788677501450-i8tc6g.ts";

describe("Defect Remediation: defect-cli-1788677501450-i8tc6g", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677501450-i8tc6g");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788677501450-i8tc6g.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788677501450-i8tc6g.test.ts",
    };
