...
} from "../../olt/scripts/src/validation/defect-cli-1788677715676-gb8gju.ts";

describe("Defect Remediation: defect-cli-1788677715676-gb8gju", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677715676-gb8gju");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788677715676-gb8gju.ts"],
