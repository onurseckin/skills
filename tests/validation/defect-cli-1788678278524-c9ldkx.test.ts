...
} from "../../olt/scripts/src/validation/defect-cli-1788678278524-c9ldkx.ts";

describe("Defect Remediation: defect-cli-1788678278524-c9ldkx", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678278524-c9ldkx");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678278524-c9ldkx.ts"],
