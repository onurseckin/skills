...
} from "../../olt/scripts/src/validation/defect-cli-1788677259377-10zsvw.ts";

describe("Defect Remediation: defect-cli-1788677259377-10zsvw", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677259377-10zsvw");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788677259377-10zsvw.ts"],
