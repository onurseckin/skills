...
} from "../../olt/scripts/src/validation/defect-cli-1788679108908-svjqkt.ts";

describe("Defect Remediation: defect-cli-1788679108908-svjqkt", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679108908-svjqkt");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679108908-svjqkt.ts"],
