...
} from "../../olt/scripts/src/validation/defect-cli-1788678210725-r0i78w.ts";

describe("Defect Remediation: defect-cli-1788678210725-r0i78w", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678210725-r0i78w");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678210725-r0i78w.ts"],
