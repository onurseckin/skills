...
} from "../../olt/scripts/src/validation/defect-cli-1788678867094-svzw5u.ts";

describe("Defect Remediation: defect-cli-1788678867094-svzw5u", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678867094-svzw5u");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678867094-svzw5u.ts"],
