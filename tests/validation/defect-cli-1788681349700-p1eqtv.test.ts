...
} from "../../olt/scripts/src/validation/defect-cli-1788681349700-p1eqtv.ts";

describe("Defect Remediation: defect-cli-1788681349700-p1eqtv", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681349700-p1eqtv");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788681349700-p1eqtv.ts"],
