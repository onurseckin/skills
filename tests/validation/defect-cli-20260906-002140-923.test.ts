...
} from "../../olt/scripts/src/validation/defect-cli-20260906-002140-923.ts";

describe("Defect Remediation: defect-cli-20260906-002140-923", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-20260906-002140-923");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-20260906-002140-923.ts"],
      gateCommand: "bun test tests/validation/defect-cli-20260906-002140-923.test.ts",
    };
