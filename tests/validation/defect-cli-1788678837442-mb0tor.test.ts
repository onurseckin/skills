...
} from "../../olt/scripts/src/validation/defect-cli-1788678837442-mb0tor.ts";

describe("Defect Remediation: defect-cli-1788678837442-mb0tor", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678837442-mb0tor");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678837442-mb0tor.ts"],
