...
} from "../../olt/scripts/src/validation/defect-cli-1788680049178-dva36n.ts";

describe("Defect Remediation: defect-cli-1788680049178-dva36n", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680049178-dva36n");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788680049178-dva36n.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788680049178-dva36n.test.ts",
    };
