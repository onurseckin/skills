...
} from "../../olt/scripts/src/validation/defect-cli-1788676665891-xrw9gt.ts";

describe("Defect Remediation: defect-cli-1788676665891-xrw9gt", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676665891-xrw9gt");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788676665891-xrw9gt.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788676665891-xrw9gt.test.ts",
    };
