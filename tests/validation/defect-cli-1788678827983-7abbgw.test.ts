...
} from "../../olt/scripts/src/validation/defect-cli-1788678827983-7abbgw.ts";

describe("Defect Remediation: defect-cli-1788678827983-7abbgw", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678827983-7abbgw");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678827983-7abbgw.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788678827983-7abbgw.test.ts",
    };
