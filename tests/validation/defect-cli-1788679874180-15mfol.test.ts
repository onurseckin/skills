...
} from "../../olt/scripts/src/validation/defect-cli-1788679874180-15mfol.ts";

describe("Defect Remediation: defect-cli-1788679874180-15mfol", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679874180-15mfol");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679874180-15mfol.ts"],
