...
} from "../../olt/scripts/src/validation/defect-cli-1788679947085-474foz.ts";

describe("Defect Remediation: defect-cli-1788679947085-474foz", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679947085-474foz");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679947085-474foz.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679947085-474foz.test.ts",
    };
