...
} from "../../olt/scripts/src/validation/defect-cli-1788677466808-fhe76v.ts";

describe("Defect Remediation: defect-cli-1788677466808-fhe76v", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677466808-fhe76v");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788677466808-fhe76v.ts"],
