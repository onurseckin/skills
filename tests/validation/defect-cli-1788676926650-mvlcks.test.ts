...
} from "../../olt/scripts/src/validation/defect-cli-1788676926650-mvlcks.ts";

describe("Defect Remediation: defect-cli-1788676926650-mvlcks", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676926650-mvlcks");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788676926650-mvlcks.ts"],
