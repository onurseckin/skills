...
} from "../../olt/scripts/src/validation/defect-cli-1788679026004-o8e83o.ts";

describe("Defect Remediation: defect-cli-1788679026004-o8e83o", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679026004-o8e83o");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679026004-o8e83o.ts"],
