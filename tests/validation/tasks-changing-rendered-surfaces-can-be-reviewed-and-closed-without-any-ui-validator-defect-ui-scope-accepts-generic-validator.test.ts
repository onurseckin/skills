...
} from "../../olt/scripts/src/validation/tasks-changing-rendered-surfaces-can-be-reviewed-and-closed-without-any-ui-validator-defect-ui-scope-accepts-generic-validator.ts";
...
describe("Defect Remediation: defect-ui-scope-accepts-generic-validator", () => {
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: [
        "olt/scripts/src/validation/tasks-changing-rendered-surfaces-can-be-reviewed-and-closed-without-any-ui-validator-defect-ui-scope-accepts-generic-validator.ts",
      ],
      gateCommand:
