...
} from "../../olt/scripts/src/validation/defect-cli-1788678850784-5gtdhz.ts";

describe("Defect Remediation: defect-cli-1788678850784-5gtdhz", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678850784-5gtdhz");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678850784-5gtdhz.ts"],
