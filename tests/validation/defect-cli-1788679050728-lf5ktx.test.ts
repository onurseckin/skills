...
} from "../../olt/scripts/src/validation/defect-cli-1788679050728-lf5ktx.ts";

describe("Defect Remediation: defect-cli-1788679050728-lf5ktx", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679050728-lf5ktx");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679050728-lf5ktx.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679050728-lf5ktx.test.ts",
    };
