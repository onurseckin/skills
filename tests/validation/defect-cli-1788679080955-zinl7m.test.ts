...
} from "../../olt/scripts/src/validation/defect-cli-1788679080955-zinl7m.ts";

describe("Defect Remediation: defect-cli-1788679080955-zinl7m", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679080955-zinl7m");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679080955-zinl7m.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679080955-zinl7m.test.ts",
    };
