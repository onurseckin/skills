...
} from "../../olt/scripts/src/validation/defect-cli-1788677223816-ewdunw.ts";

describe("Defect Remediation: defect-cli-1788677223816-ewdunw", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677223816-ewdunw");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788677223816-ewdunw.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788677223816-ewdunw.test.ts",
    };
