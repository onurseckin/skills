...
} from "../../olt/scripts/src/validation/defect-cli-1788679500002-auditorblind.ts";

describe("Defect Remediation: defect-cli-1788679500002-auditorblind", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679500002-auditorblind");
    expect(ERROR_CODE).toBe("HOST_TRANSCRIPT_BLINDNESS");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679500002-auditorblind.ts"],
