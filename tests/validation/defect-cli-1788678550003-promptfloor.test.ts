...
} from "../../olt/scripts/src/validation/defect-cli-1788678550003-promptfloor.ts";

describe("Defect Remediation: defect-cli-1788678550003-promptfloor", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678550003-promptfloor");
    expect(ERROR_CODE).toBe("MISSING_PROMPT_BYTE_FLOOR");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678550003-promptfloor.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788678550003-promptfloor.test.ts",
    };
