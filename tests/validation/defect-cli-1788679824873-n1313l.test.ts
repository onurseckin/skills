...
} from "../../olt/scripts/src/validation/defect-cli-1788679824873-n1313l.ts";

describe("Defect Remediation: defect-cli-1788679824873-n1313l", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679824873-n1313l");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679824873-n1313l.ts"],
