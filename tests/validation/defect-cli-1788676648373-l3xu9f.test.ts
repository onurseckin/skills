...
} from "../../olt/scripts/src/validation/defect-cli-1788676648373-l3xu9f.ts";

describe("Defect Remediation: defect-cli-1788676648373-l3xu9f", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676648373-l3xu9f");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788676648373-l3xu9f.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788676648373-l3xu9f.test.ts",
    };
