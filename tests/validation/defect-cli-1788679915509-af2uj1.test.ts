...
} from "../../olt/scripts/src/validation/defect-cli-1788679915509-af2uj1.ts";

describe("Defect Remediation: defect-cli-1788679915509-af2uj1", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679915509-af2uj1");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679915509-af2uj1.ts"],
