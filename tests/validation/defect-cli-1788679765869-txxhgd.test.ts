...
} from "../../olt/scripts/src/validation/defect-cli-1788679765869-txxhgd.ts";

describe("Defect Remediation: defect-cli-1788679765869-txxhgd", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679765869-txxhgd");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679765869-txxhgd.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679765869-txxhgd.test.ts",
    };
