...
} from "../../olt/scripts/src/validation/defect-cli-1788679082622-p916gu.ts";

describe("Defect Remediation: defect-cli-1788679082622-p916gu", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679082622-p916gu");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679082622-p916gu.ts"],
