...
} from "../../olt/scripts/src/validation/defect-cli-1788680177286-owj6gw.ts";

describe("Defect Remediation: defect-cli-1788680177286-owj6gw", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680177286-owj6gw");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788680177286-owj6gw.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788680177286-owj6gw.test.ts",
    };
