...
} from "../../olt/scripts/src/validation/defect-cli-1788679080483-8csaqs.ts";

describe("Defect Remediation: defect-cli-1788679080483-8csaqs", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679080483-8csaqs");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679080483-8csaqs.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679080483-8csaqs.test.ts",
    };
