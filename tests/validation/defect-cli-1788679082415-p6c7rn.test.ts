...
} from "../../olt/scripts/src/validation/defect-cli-1788679082415-p6c7rn.ts";

describe("Defect Remediation: defect-cli-1788679082415-p6c7rn", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679082415-p6c7rn");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679082415-p6c7rn.ts"],
