...
} from "../../olt/scripts/src/validation/defect-cli-1788679500001-coordbypass.ts";

describe("Defect Remediation: defect-cli-1788679500001-coordbypass", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679500001-coordbypass");
    expect(ERROR_CODE).toBe("ROLE_CONFINEMENT_BYPASS");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679500001-coordbypass.ts"],
