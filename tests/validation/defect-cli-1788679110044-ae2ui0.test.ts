...
} from "../../olt/scripts/src/validation/defect-cli-1788679110044-ae2ui0.ts";

describe("Defect Remediation: defect-cli-1788679110044-ae2ui0", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679110044-ae2ui0");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679110044-ae2ui0.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679110044-ae2ui0.test.ts",
    };
