...
} from "../../olt/scripts/src/validation/defect-cli-1788679263842-xlupbq.ts";

describe("Defect Remediation: defect-cli-1788679263842-xlupbq", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679263842-xlupbq");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679263842-xlupbq.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679263842-xlupbq.test.ts",
    };
