...
} from "../../olt/scripts/src/validation/defect-cli-1788679422085-elf1jj.ts";

describe("Defect Remediation: defect-cli-1788679422085-elf1jj", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679422085-elf1jj");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679422085-elf1jj.ts"],
