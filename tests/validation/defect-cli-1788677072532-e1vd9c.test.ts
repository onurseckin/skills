...
} from "../../olt/scripts/src/validation/defect-cli-1788677072532-e1vd9c.ts";

describe("Defect Remediation: defect-cli-1788677072532-e1vd9c", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677072532-e1vd9c");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788677072532-e1vd9c.ts"],
