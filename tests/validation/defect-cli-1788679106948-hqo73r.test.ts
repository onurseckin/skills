...
} from "../../olt/scripts/src/validation/defect-cli-1788679106948-hqo73r.ts";

describe("Defect Remediation: defect-cli-1788679106948-hqo73r", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679106948-hqo73r");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679106948-hqo73r.ts"],
