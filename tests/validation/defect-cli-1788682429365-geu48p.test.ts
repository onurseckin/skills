...
} from "../../olt/scripts/src/validation/defect-cli-1788682429365-geu48p.ts";

describe("Defect Remediation: defect-cli-1788682429365-geu48p", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682429365-geu48p");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788682429365-geu48p.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788682429365-geu48p.test.ts",
    };
