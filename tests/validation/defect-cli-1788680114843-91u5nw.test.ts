...
} from "../../olt/scripts/src/validation/defect-cli-1788680114843-91u5nw.ts";

describe("Defect Remediation: defect-cli-1788680114843-91u5nw", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680114843-91u5nw");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788680114843-91u5nw.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788680114843-91u5nw.test.ts",
    };
