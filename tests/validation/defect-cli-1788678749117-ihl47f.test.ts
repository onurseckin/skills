...
} from "../../olt/scripts/src/validation/defect-cli-1788678749117-ihl47f.ts";

describe("Defect Remediation: defect-cli-1788678749117-ihl47f", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678749117-ihl47f");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678749117-ihl47f.ts"],
