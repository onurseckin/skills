...
} from "../../olt/scripts/src/validation/defect-cli-1788678697751-jutwsn.ts";

describe("Defect Remediation: defect-cli-1788678697751-jutwsn", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678697751-jutwsn");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678697751-jutwsn.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788678697751-jutwsn.test.ts",
    };
