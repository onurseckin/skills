...
} from "../../olt/scripts/src/validation/defect-cli-1788679085837-5nnogr.ts";

describe("Defect Remediation: defect-cli-1788679085837-5nnogr", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679085837-5nnogr");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679085837-5nnogr.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679085837-5nnogr.test.ts",
    };
