...
} from "../../olt/scripts/src/validation/defect-cli-1788681895698-87eycj.ts";

describe("Defect Remediation: defect-cli-1788681895698-87eycj", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681895698-87eycj");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788681895698-87eycj.ts"],
