...
} from "../../olt/scripts/src/validation/defect-cli-1788678829509-3xtnmi.ts";

describe("Defect Remediation: defect-cli-1788678829509-3xtnmi", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678829509-3xtnmi");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678829509-3xtnmi.ts"],
