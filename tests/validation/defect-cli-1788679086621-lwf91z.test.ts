...
} from "../../olt/scripts/src/validation/defect-cli-1788679086621-lwf91z.ts";

describe("Defect Remediation: defect-cli-1788679086621-lwf91z", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679086621-lwf91z");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679086621-lwf91z.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679086621-lwf91z.test.ts",
    };
