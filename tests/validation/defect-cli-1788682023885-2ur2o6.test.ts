...
} from "../../olt/scripts/src/validation/defect-cli-1788682023885-2ur2o6.ts";

describe("Defect Remediation: defect-cli-1788682023885-2ur2o6", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682023885-2ur2o6");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788682023885-2ur2o6.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788682023885-2ur2o6.test.ts",
    };
