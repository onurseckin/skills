...
} from "../../olt/scripts/src/validation/defect-cli-1788678768751-uv8zks.ts";

describe("Defect Remediation: defect-cli-1788678768751-uv8zks", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678768751-uv8zks");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788678768751-uv8zks.ts"],
