...
} from "../../olt/scripts/src/validation/defect-cli-1788679131869-q3f01n.ts";

describe("Defect Remediation: defect-cli-1788679131869-q3f01n", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679131869-q3f01n");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      scope: ["olt/scripts/src/validation/defect-cli-1788679131869-q3f01n.ts"],
      gateCommand: "bun test tests/validation/defect-cli-1788679131869-q3f01n.test.ts",
    };
