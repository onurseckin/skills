...
} from "../../olt/scripts/src/core/defect-cli-1788679534444-n39oyd.ts";

describe("Defect Remediation: defect-cli-1788679534444-n39oyd", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679534444-n39oyd");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-73",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679534444-n39oyd",
      scope: ["olt/scripts/src/core/defect-cli-1788679534444-n39oyd.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679534444-n39oyd.test.ts",
      options: ["--compliant"],
    };
