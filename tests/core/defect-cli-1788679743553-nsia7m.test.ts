...
} from "../../olt/scripts/src/core/defect-cli-1788679743553-nsia7m.ts";

describe("Defect Remediation: defect-cli-1788679743553-nsia7m", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679743553-nsia7m");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-89",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679743553-nsia7m",
      scope: ["olt/scripts/src/core/defect-cli-1788679743553-nsia7m.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679743553-nsia7m.test.ts",
      options: ["--compliant"],
    };
