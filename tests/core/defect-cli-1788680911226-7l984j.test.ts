...
} from "../../olt/scripts/src/core/defect-cli-1788680911226-7l984j.ts";

describe("Defect Remediation: defect-cli-1788680911226-7l984j", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680911226-7l984j");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-123",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680911226-7l984j",
      scope: ["olt/scripts/src/core/defect-cli-1788680911226-7l984j.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680911226-7l984j.test.ts",
      options: ["--compliant"],
    };
