...
} from "../../olt/scripts/src/core/defect-cli-1788679356240-nnbwma.ts";

describe("Defect Remediation: defect-cli-1788679356240-nnbwma", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679356240-nnbwma");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-55",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679356240-nnbwma",
      scope: ["olt/scripts/src/core/defect-cli-1788679356240-nnbwma.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679356240-nnbwma.test.ts",
      options: ["--compliant"],
    };
