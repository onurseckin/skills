...
} from "../../olt/scripts/src/core/defect-cli-1788679438508-ywptam.ts";

describe("Defect Remediation: defect-cli-1788679438508-ywptam", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679438508-ywptam");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-68",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679438508-ywptam",
      scope: ["olt/scripts/src/core/defect-cli-1788679438508-ywptam.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679438508-ywptam.test.ts",
      options: ["--compliant"],
    };
