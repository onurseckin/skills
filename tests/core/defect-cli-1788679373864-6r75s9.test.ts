...
} from "../../olt/scripts/src/core/defect-cli-1788679373864-6r75s9.ts";

describe("Defect Remediation: defect-cli-1788679373864-6r75s9", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679373864-6r75s9");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-61",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679373864-6r75s9",
      scope: ["olt/scripts/src/core/defect-cli-1788679373864-6r75s9.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679373864-6r75s9.test.ts",
      options: ["--compliant"],
    };
