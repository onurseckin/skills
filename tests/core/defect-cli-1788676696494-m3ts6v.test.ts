...
} from "../../olt/scripts/src/core/defect-cli-1788676696494-m3ts6v.ts";

describe("Defect Remediation: defect-cli-1788676696494-m3ts6v", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676696494-m3ts6v");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-1",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788676696494-m3ts6v",
      scope: ["olt/scripts/src/core/defect-cli-1788676696494-m3ts6v.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788676696494-m3ts6v.test.ts",
      options: ["--compliant"],
    };
