...
} from "../../olt/scripts/src/core/defect-cli-1788679308223-pvarlq.ts";

describe("Defect Remediation: defect-cli-1788679308223-pvarlq", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679308223-pvarlq");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-52",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679308223-pvarlq",
      scope: ["olt/scripts/src/core/defect-cli-1788679308223-pvarlq.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679308223-pvarlq.test.ts",
      options: ["--compliant"],
    };
