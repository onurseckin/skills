...
} from "../../olt/scripts/src/core/defect-cli-1788679308218-bc3u2o.ts";

describe("Defect Remediation: defect-cli-1788679308218-bc3u2o", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679308218-bc3u2o");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-49",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679308218-bc3u2o",
      scope: ["olt/scripts/src/core/defect-cli-1788679308218-bc3u2o.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679308218-bc3u2o.test.ts",
      options: ["--compliant"],
    };
