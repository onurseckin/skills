...
} from "../../olt/scripts/src/core/defect-cli-1788677756964-pm3ltw.ts";

describe("Defect Remediation: defect-cli-1788677756964-pm3ltw", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677756964-pm3ltw");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-17",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677756964-pm3ltw",
      scope: ["olt/scripts/src/core/defect-cli-1788677756964-pm3ltw.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677756964-pm3ltw.test.ts",
      options: ["--compliant"],
    };
