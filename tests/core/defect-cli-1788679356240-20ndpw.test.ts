...
} from "../../olt/scripts/src/core/defect-cli-1788679356240-20ndpw.ts";

describe("Defect Remediation: defect-cli-1788679356240-20ndpw", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679356240-20ndpw");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-57",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679356240-20ndpw",
      scope: ["olt/scripts/src/core/defect-cli-1788679356240-20ndpw.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679356240-20ndpw.test.ts",
      options: ["--compliant"],
    };
