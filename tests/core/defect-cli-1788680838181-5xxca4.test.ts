...
} from "../../olt/scripts/src/core/defect-cli-1788680838181-5xxca4.ts";

describe("Defect Remediation: defect-cli-1788680838181-5xxca4", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680838181-5xxca4");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-121",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680838181-5xxca4",
      scope: ["olt/scripts/src/core/defect-cli-1788680838181-5xxca4.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680838181-5xxca4.test.ts",
      options: ["--compliant"],
    };
