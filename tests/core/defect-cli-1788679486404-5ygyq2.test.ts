...
} from "../../olt/scripts/src/core/defect-cli-1788679486404-5ygyq2.ts";

describe("Defect Remediation: defect-cli-1788679486404-5ygyq2", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679486404-5ygyq2");
