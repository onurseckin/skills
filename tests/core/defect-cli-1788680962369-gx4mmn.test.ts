...
} from "../../olt/scripts/src/core/defect-cli-1788680962369-gx4mmn.ts";

describe("Defect Remediation: defect-cli-1788680962369-gx4mmn", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680962369-gx4mmn");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-130",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680962369-gx4mmn",
      scope: ["olt/scripts/src/core/defect-cli-1788680962369-gx4mmn.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680962369-gx4mmn.test.ts",
      options: ["--compliant"],
    };
