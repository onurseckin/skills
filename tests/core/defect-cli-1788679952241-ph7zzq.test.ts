...
} from "../../olt/scripts/src/core/defect-cli-1788679952241-ph7zzq.ts";

describe("Defect Remediation: defect-cli-1788679952241-ph7zzq", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679952241-ph7zzq");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-101",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679952241-ph7zzq",
      scope: ["olt/scripts/src/core/defect-cli-1788679952241-ph7zzq.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679952241-ph7zzq.test.ts",
      options: ["--compliant"],
    };
