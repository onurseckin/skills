...
} from "../../olt/scripts/src/core/defect-cli-1788679487528-ajlrdn.ts";

describe("Defect Remediation: defect-cli-1788679487528-ajlrdn", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679487528-ajlrdn");
