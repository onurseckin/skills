...
} from "../../olt/scripts/src/core/defect-cli-1788678251949-icic0f.ts";

describe("Defect Remediation: defect-cli-1788678251949-icic0f", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678251949-icic0f");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-25",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678251949-icic0f",
      scope: ["olt/scripts/src/core/defect-cli-1788678251949-icic0f.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678251949-icic0f.test.ts",
      options: ["--compliant"],
    };
