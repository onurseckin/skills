...
} from "../../olt/scripts/src/core/defect-cli-1788678861175-4gvnci.ts";

describe("Defect Remediation: defect-cli-1788678861175-4gvnci", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678861175-4gvnci");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-31",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678861175-4gvnci",
      scope: ["olt/scripts/src/core/defect-cli-1788678861175-4gvnci.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678861175-4gvnci.test.ts",
      options: ["--compliant"],
    };
