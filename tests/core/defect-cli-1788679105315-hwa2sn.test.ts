...
} from "../../olt/scripts/src/core/defect-cli-1788679105315-hwa2sn.ts";

describe("Defect Remediation: defect-cli-1788679105315-hwa2sn", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679105315-hwa2sn");
