...
} from "../../olt/scripts/src/core/defect-cli-1788682417823-qo2dkd.ts";

describe("Defect Remediation: defect-cli-1788682417823-qo2dkd", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682417823-qo2dkd");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-149",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682417823-qo2dkd",
      scope: ["olt/scripts/src/core/defect-cli-1788682417823-qo2dkd.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682417823-qo2dkd.test.ts",
      options: ["--compliant"],
    };
