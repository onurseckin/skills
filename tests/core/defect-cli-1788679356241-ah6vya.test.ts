...
} from "../../olt/scripts/src/core/defect-cli-1788679356241-ah6vya.ts";

describe("Defect Remediation: defect-cli-1788679356241-ah6vya", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679356241-ah6vya");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-58",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679356241-ah6vya",
      scope: ["olt/scripts/src/core/defect-cli-1788679356241-ah6vya.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679356241-ah6vya.test.ts",
      options: ["--compliant"],
    };
