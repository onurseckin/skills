...
} from "../../olt/scripts/src/core/defect-cli-1788681623959-v501g6.ts";

describe("Defect Remediation: defect-cli-1788681623959-v501g6", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681623959-v501g6");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-135",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788681623959-v501g6",
      scope: ["olt/scripts/src/core/defect-cli-1788681623959-v501g6.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788681623959-v501g6.test.ts",
      options: ["--compliant"],
    };
