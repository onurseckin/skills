...
} from "../../olt/scripts/src/core/defect-cli-1788679492062-5uqcjp.ts";

describe("Defect Remediation: defect-cli-1788679492062-5uqcjp", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679492062-5uqcjp");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-72",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679492062-5uqcjp",
      scope: ["olt/scripts/src/core/defect-cli-1788679492062-5uqcjp.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679492062-5uqcjp.test.ts",
      options: ["--compliant"],
    };
