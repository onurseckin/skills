...
} from "../../olt/scripts/src/core/defect-cli-1788677420405-cz7yha.ts";

describe("Defect Remediation: defect-cli-1788677420405-cz7yha", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677420405-cz7yha");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-12",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677420405-cz7yha",
      scope: ["olt/scripts/src/core/defect-cli-1788677420405-cz7yha.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677420405-cz7yha.test.ts",
      options: ["--compliant"],
    };
