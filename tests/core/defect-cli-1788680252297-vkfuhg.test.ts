...
} from "../../olt/scripts/src/core/defect-cli-1788680252297-vkfuhg.ts";

describe("Defect Remediation: defect-cli-1788680252297-vkfuhg", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680252297-vkfuhg");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-119",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680252297-vkfuhg",
      scope: ["olt/scripts/src/core/defect-cli-1788680252297-vkfuhg.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680252297-vkfuhg.test.ts",
      options: ["--compliant"],
    };
