...
} from "../../olt/scripts/src/core/defect-cli-1788679665539-dsu1zo.ts";

describe("Defect Remediation: defect-cli-1788679665539-dsu1zo", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679665539-dsu1zo");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-83",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679665539-dsu1zo",
      scope: ["olt/scripts/src/core/defect-cli-1788679665539-dsu1zo.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679665539-dsu1zo.test.ts",
      options: ["--compliant"],
    };
