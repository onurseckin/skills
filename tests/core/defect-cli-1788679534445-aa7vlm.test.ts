...
} from "../../olt/scripts/src/core/defect-cli-1788679534445-aa7vlm.ts";

describe("Defect Remediation: defect-cli-1788679534445-aa7vlm", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679534445-aa7vlm");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-76",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679534445-aa7vlm",
      scope: ["olt/scripts/src/core/defect-cli-1788679534445-aa7vlm.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679534445-aa7vlm.test.ts",
      options: ["--compliant"],
    };
