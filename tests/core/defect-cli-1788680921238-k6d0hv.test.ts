...
} from "../../olt/scripts/src/core/defect-cli-1788680921238-k6d0hv.ts";

describe("Defect Remediation: defect-cli-1788680921238-k6d0hv", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680921238-k6d0hv");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-125",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680921238-k6d0hv",
      scope: ["olt/scripts/src/core/defect-cli-1788680921238-k6d0hv.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680921238-k6d0hv.test.ts",
      options: ["--compliant"],
    };
