...
} from "../../olt/scripts/src/core/defect-cli-1788680921239-so96zo.ts";

describe("Defect Remediation: defect-cli-1788680921239-so96zo", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680921239-so96zo");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-127",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680921239-so96zo",
      scope: ["olt/scripts/src/core/defect-cli-1788680921239-so96zo.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680921239-so96zo.test.ts",
      options: ["--compliant"],
    };
