...
} from "../../olt/scripts/src/core/defect-cli-1788679991229-71gjf8.ts";

describe("Defect Remediation: defect-cli-1788679991229-71gjf8", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679991229-71gjf8");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-106",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679991229-71gjf8",
      scope: ["olt/scripts/src/core/defect-cli-1788679991229-71gjf8.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679991229-71gjf8.test.ts",
      options: ["--compliant"],
    };
