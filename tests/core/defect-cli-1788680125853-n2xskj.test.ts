...
} from "../../olt/scripts/src/core/defect-cli-1788680125853-n2xskj.ts";

describe("Defect Remediation: defect-cli-1788680125853-n2xskj", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680125853-n2xskj");
