...
} from "../../olt/scripts/src/core/defect-cli-1788677227839-wf5fm1.ts";

describe("Defect Remediation: defect-cli-1788677227839-wf5fm1", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677227839-wf5fm1");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-10",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677227839-wf5fm1",
      scope: ["olt/scripts/src/core/defect-cli-1788677227839-wf5fm1.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677227839-wf5fm1.test.ts",
      options: ["--compliant"],
    };
