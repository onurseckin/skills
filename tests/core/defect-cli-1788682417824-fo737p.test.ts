...
} from "../../olt/scripts/src/core/defect-cli-1788682417824-fo737p.ts";

describe("Defect Remediation: defect-cli-1788682417824-fo737p", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682417824-fo737p");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-151",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682417824-fo737p",
      scope: ["olt/scripts/src/core/defect-cli-1788682417824-fo737p.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682417824-fo737p.test.ts",
      options: ["--compliant"],
    };
