...
} from "../../olt/scripts/src/core/defect-cli-1788677860001-3wblgg.ts";

describe("Defect Remediation: defect-cli-1788677860001-3wblgg", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677860001-3wblgg");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-21",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677860001-3wblgg",
      scope: ["olt/scripts/src/core/defect-cli-1788677860001-3wblgg.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677860001-3wblgg.test.ts",
      options: ["--compliant"],
    };
