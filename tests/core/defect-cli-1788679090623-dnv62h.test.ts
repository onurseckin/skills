...
} from "../../olt/scripts/src/core/defect-cli-1788679090623-dnv62h.ts";

describe("Defect Remediation: defect-cli-1788679090623-dnv62h", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679090623-dnv62h");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-36",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679090623-dnv62h",
      scope: ["olt/scripts/src/core/defect-cli-1788679090623-dnv62h.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679090623-dnv62h.test.ts",
      options: ["--compliant"],
    };
