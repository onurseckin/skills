...
} from "../../olt/scripts/src/core/defect-cli-1788680921234-s76koo.ts";

describe("Defect Remediation: defect-cli-1788680921234-s76koo", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680921234-s76koo");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-124",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680921234-s76koo",
      scope: ["olt/scripts/src/core/defect-cli-1788680921234-s76koo.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680921234-s76koo.test.ts",
      options: ["--compliant"],
    };
