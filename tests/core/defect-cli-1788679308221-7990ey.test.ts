...
} from "../../olt/scripts/src/core/defect-cli-1788679308221-7990ey.ts";

describe("Defect Remediation: defect-cli-1788679308221-7990ey", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679308221-7990ey");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-51",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679308221-7990ey",
      scope: ["olt/scripts/src/core/defect-cli-1788679308221-7990ey.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679308221-7990ey.test.ts",
      options: ["--compliant"],
    };
