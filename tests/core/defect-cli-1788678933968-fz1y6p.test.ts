...
} from "../../olt/scripts/src/core/defect-cli-1788678933968-fz1y6p.ts";

describe("Defect Remediation: defect-cli-1788678933968-fz1y6p", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678933968-fz1y6p");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-33",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678933968-fz1y6p",
      scope: ["olt/scripts/src/core/defect-cli-1788678933968-fz1y6p.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678933968-fz1y6p.test.ts",
      options: ["--compliant"],
    };
