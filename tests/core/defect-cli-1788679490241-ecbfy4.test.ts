...
} from "../../olt/scripts/src/core/defect-cli-1788679490241-ecbfy4.ts";

describe("Defect Remediation: defect-cli-1788679490241-ecbfy4", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679490241-ecbfy4");
