...
} from "../../olt/scripts/src/core/defect-cli-1788679113069-2uyp7s.ts";

describe("Defect Remediation: defect-cli-1788679113069-2uyp7s", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679113069-2uyp7s");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-39",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679113069-2uyp7s",
      scope: ["olt/scripts/src/core/defect-cli-1788679113069-2uyp7s.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679113069-2uyp7s.test.ts",
      options: ["--compliant"],
    };
