...
} from "../../olt/scripts/src/core/defect-cli-1788678174288-37a7lb.ts";

describe("Defect Remediation: defect-cli-1788678174288-37a7lb", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678174288-37a7lb");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-23",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678174288-37a7lb",
      scope: ["olt/scripts/src/core/defect-cli-1788678174288-37a7lb.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678174288-37a7lb.test.ts",
      options: ["--compliant"],
    };
