...
} from "../../olt/scripts/src/core/defect-cli-1788678881303-dkr2au.ts";

describe("Defect Remediation: defect-cli-1788678881303-dkr2au", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678881303-dkr2au");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-32",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678881303-dkr2au",
      scope: ["olt/scripts/src/core/defect-cli-1788678881303-dkr2au.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678881303-dkr2au.test.ts",
      options: ["--compliant"],
    };
