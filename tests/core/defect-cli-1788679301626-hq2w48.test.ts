...
} from "../../olt/scripts/src/core/defect-cli-1788679301626-hq2w48.ts";

describe("Defect Remediation: defect-cli-1788679301626-hq2w48", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679301626-hq2w48");
