...
} from "../../olt/scripts/src/core/defect-cli-1788679749389-ol8qpl.ts";

describe("Defect Remediation: defect-cli-1788679749389-ol8qpl", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679749389-ol8qpl");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-93",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679749389-ol8qpl",
      scope: ["olt/scripts/src/core/defect-cli-1788679749389-ol8qpl.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679749389-ol8qpl.test.ts",
      options: ["--compliant"],
    };
