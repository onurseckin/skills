...
} from "../../olt/scripts/src/core/defect-cli-1788680809119-jf2org.ts";

describe("Defect Remediation: defect-cli-1788680809119-jf2org", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680809119-jf2org");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-120",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680809119-jf2org",
      scope: ["olt/scripts/src/core/defect-cli-1788680809119-jf2org.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680809119-jf2org.test.ts",
      options: ["--compliant"],
    };
