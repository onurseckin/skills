...
} from "../../olt/scripts/src/core/defect-cli-1788680107580-lfctap.ts";

describe("Defect Remediation: defect-cli-1788680107580-lfctap", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680107580-lfctap");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-110",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680107580-lfctap",
      scope: ["olt/scripts/src/core/defect-cli-1788680107580-lfctap.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680107580-lfctap.test.ts",
      options: ["--compliant"],
    };
