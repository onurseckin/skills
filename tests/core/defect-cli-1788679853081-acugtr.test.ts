...
} from "../../olt/scripts/src/core/defect-cli-1788679853081-acugtr.ts";

describe("Defect Remediation: defect-cli-1788679853081-acugtr", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679853081-acugtr");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-98",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679853081-acugtr",
      scope: ["olt/scripts/src/core/defect-cli-1788679853081-acugtr.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679853081-acugtr.test.ts",
      options: ["--compliant"],
    };
