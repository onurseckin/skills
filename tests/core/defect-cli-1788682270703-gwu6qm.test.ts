...
} from "../../olt/scripts/src/core/defect-cli-1788682270703-gwu6qm.ts";

describe("Defect Remediation: defect-cli-1788682270703-gwu6qm", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682270703-gwu6qm");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-144",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682270703-gwu6qm",
      scope: ["olt/scripts/src/core/defect-cli-1788682270703-gwu6qm.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682270703-gwu6qm.test.ts",
      options: ["--compliant"],
    };
