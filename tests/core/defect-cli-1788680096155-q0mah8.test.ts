...
} from "../../olt/scripts/src/core/defect-cli-1788680096155-q0mah8.ts";

describe("Defect Remediation: defect-cli-1788680096155-q0mah8", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680096155-q0mah8");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-108",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680096155-q0mah8",
      scope: ["olt/scripts/src/core/defect-cli-1788680096155-q0mah8.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680096155-q0mah8.test.ts",
      options: ["--compliant"],
    };
