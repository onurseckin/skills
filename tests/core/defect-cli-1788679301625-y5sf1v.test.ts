...
} from "../../olt/scripts/src/core/defect-cli-1788679301625-y5sf1v.ts";

describe("Defect Remediation: defect-cli-1788679301625-y5sf1v", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679301625-y5sf1v");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-44",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679301625-y5sf1v",
      scope: ["olt/scripts/src/core/defect-cli-1788679301625-y5sf1v.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679301625-y5sf1v.test.ts",
      options: ["--compliant"],
    };
