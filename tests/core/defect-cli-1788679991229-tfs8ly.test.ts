...
} from "../../olt/scripts/src/core/defect-cli-1788679991229-tfs8ly.ts";

describe("Defect Remediation: defect-cli-1788679991229-tfs8ly", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679991229-tfs8ly");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-105",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679991229-tfs8ly",
      scope: ["olt/scripts/src/core/defect-cli-1788679991229-tfs8ly.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679991229-tfs8ly.test.ts",
      options: ["--compliant"],
    };
