...
} from "../../olt/scripts/src/core/defect-cli-1788679604544-wukn35.ts";

describe("Defect Remediation: defect-cli-1788679604544-wukn35", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679604544-wukn35");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-82",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679604544-wukn35",
      scope: ["olt/scripts/src/core/defect-cli-1788679604544-wukn35.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679604544-wukn35.test.ts",
      options: ["--compliant"],
    };
