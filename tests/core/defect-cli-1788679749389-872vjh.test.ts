...
} from "../../olt/scripts/src/core/defect-cli-1788679749389-872vjh.ts";

describe("Defect Remediation: defect-cli-1788679749389-872vjh", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679749389-872vjh");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-92",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679749389-872vjh",
      scope: ["olt/scripts/src/core/defect-cli-1788679749389-872vjh.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679749389-872vjh.test.ts",
      options: ["--compliant"],
    };
