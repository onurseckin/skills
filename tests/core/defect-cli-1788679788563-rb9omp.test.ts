...
} from "../../olt/scripts/src/core/defect-cli-1788679788563-rb9omp.ts";

describe("Defect Remediation: defect-cli-1788679788563-rb9omp", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679788563-rb9omp");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-96",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679788563-rb9omp",
      scope: ["olt/scripts/src/core/defect-cli-1788679788563-rb9omp.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679788563-rb9omp.test.ts",
      options: ["--compliant"],
    };
