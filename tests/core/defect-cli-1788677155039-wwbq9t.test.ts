...
} from "../../olt/scripts/src/core/defect-cli-1788677155039-wwbq9t.ts";

describe("Defect Remediation: defect-cli-1788677155039-wwbq9t", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677155039-wwbq9t");
