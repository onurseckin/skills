...
} from "../../olt/scripts/src/core/defect-cli-1788678041651-7wtpfg.ts";

describe("Defect Remediation: defect-cli-1788678041651-7wtpfg", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678041651-7wtpfg");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-22",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678041651-7wtpfg",
      scope: ["olt/scripts/src/core/defect-cli-1788678041651-7wtpfg.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678041651-7wtpfg.test.ts",
      options: ["--compliant"],
    };
