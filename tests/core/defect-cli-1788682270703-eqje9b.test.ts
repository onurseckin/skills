...
} from "../../olt/scripts/src/core/defect-cli-1788682270703-eqje9b.ts";

describe("Defect Remediation: defect-cli-1788682270703-eqje9b", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682270703-eqje9b");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-143",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682270703-eqje9b",
      scope: ["olt/scripts/src/core/defect-cli-1788682270703-eqje9b.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682270703-eqje9b.test.ts",
      options: ["--compliant"],
    };
