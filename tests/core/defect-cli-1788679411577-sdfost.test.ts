...
} from "../../olt/scripts/src/core/defect-cli-1788679411577-sdfost.ts";

describe("Defect Remediation: defect-cli-1788679411577-sdfost", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679411577-sdfost");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-67",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679411577-sdfost",
      scope: ["olt/scripts/src/core/defect-cli-1788679411577-sdfost.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679411577-sdfost.test.ts",
      options: ["--compliant"],
    };
