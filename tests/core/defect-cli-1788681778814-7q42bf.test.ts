...
} from "../../olt/scripts/src/core/defect-cli-1788681778814-7q42bf.ts";

describe("Defect Remediation: defect-cli-1788681778814-7q42bf", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681778814-7q42bf");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-136",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788681778814-7q42bf",
      scope: ["olt/scripts/src/core/defect-cli-1788681778814-7q42bf.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788681778814-7q42bf.test.ts",
      options: ["--compliant"],
    };
