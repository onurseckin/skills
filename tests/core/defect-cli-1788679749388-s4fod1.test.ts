...
} from "../../olt/scripts/src/core/defect-cli-1788679749388-s4fod1.ts";

describe("Defect Remediation: defect-cli-1788679749388-s4fod1", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679749388-s4fod1");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-91",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679749388-s4fod1",
      scope: ["olt/scripts/src/core/defect-cli-1788679749388-s4fod1.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679749388-s4fod1.test.ts",
      options: ["--compliant"],
    };
