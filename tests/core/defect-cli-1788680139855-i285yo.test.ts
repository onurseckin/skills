...
} from "../../olt/scripts/src/core/defect-cli-1788680139855-i285yo.ts";

describe("Defect Remediation: defect-cli-1788680139855-i285yo", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680139855-i285yo");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-114",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680139855-i285yo",
      scope: ["olt/scripts/src/core/defect-cli-1788680139855-i285yo.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680139855-i285yo.test.ts",
      options: ["--compliant"],
    };
