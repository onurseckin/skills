...
} from "../../olt/scripts/src/core/defect-cli-1788680137732-j2okmo.ts";

describe("Defect Remediation: defect-cli-1788680137732-j2okmo", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680137732-j2okmo");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-113",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680137732-j2okmo",
      scope: ["olt/scripts/src/core/defect-cli-1788680137732-j2okmo.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680137732-j2okmo.test.ts",
      options: ["--compliant"],
    };
