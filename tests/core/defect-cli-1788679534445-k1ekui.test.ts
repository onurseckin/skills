...
} from "../../olt/scripts/src/core/defect-cli-1788679534445-k1ekui.ts";

describe("Defect Remediation: defect-cli-1788679534445-k1ekui", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679534445-k1ekui");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-77",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679534445-k1ekui",
      scope: ["olt/scripts/src/core/defect-cli-1788679534445-k1ekui.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679534445-k1ekui.test.ts",
      options: ["--compliant"],
    };
