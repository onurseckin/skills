...
} from "../../olt/scripts/src/core/defect-cli-1788679274886-jjhkfo.ts";

describe("Defect Remediation: defect-cli-1788679274886-jjhkfo", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679274886-jjhkfo");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-42",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679274886-jjhkfo",
      scope: ["olt/scripts/src/core/defect-cli-1788679274886-jjhkfo.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679274886-jjhkfo.test.ts",
      options: ["--compliant"],
    };
