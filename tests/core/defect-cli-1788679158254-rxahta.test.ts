...
} from "../../olt/scripts/src/core/defect-cli-1788679158254-rxahta.ts";

describe("Defect Remediation: defect-cli-1788679158254-rxahta", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679158254-rxahta");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-41",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679158254-rxahta",
      scope: ["olt/scripts/src/core/defect-cli-1788679158254-rxahta.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679158254-rxahta.test.ts",
      options: ["--compliant"],
    };
