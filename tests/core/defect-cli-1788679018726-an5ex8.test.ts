...
} from "../../olt/scripts/src/core/defect-cli-1788679018726-an5ex8.ts";

describe("Defect Remediation: defect-cli-1788679018726-an5ex8", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679018726-an5ex8");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-35",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679018726-an5ex8",
      scope: ["olt/scripts/src/core/defect-cli-1788679018726-an5ex8.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679018726-an5ex8.test.ts",
      options: ["--compliant"],
    };
