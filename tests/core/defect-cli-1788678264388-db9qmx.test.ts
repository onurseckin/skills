...
} from "../../olt/scripts/src/core/defect-cli-1788678264388-db9qmx.ts";

describe("Defect Remediation: defect-cli-1788678264388-db9qmx", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678264388-db9qmx");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-26",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678264388-db9qmx",
      scope: ["olt/scripts/src/core/defect-cli-1788678264388-db9qmx.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678264388-db9qmx.test.ts",
      options: ["--compliant"],
    };
