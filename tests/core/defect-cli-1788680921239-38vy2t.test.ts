...
} from "../../olt/scripts/src/core/defect-cli-1788680921239-38vy2t.ts";

describe("Defect Remediation: defect-cli-1788680921239-38vy2t", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680921239-38vy2t");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-126",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680921239-38vy2t",
      scope: ["olt/scripts/src/core/defect-cli-1788680921239-38vy2t.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680921239-38vy2t.test.ts",
      options: ["--compliant"],
    };
