...
} from "../../olt/scripts/src/core/defect-cli-1788679500003-probedeadlock.ts";

describe("Defect Remediation: defect-cli-1788679500003-probedeadlock", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679500003-probedeadlock");
    expect(ERROR_CODE).toBe("PROBE_RESOLUTION_DEADLOCK");
