...
} from "../../olt/scripts/src/core/defect-cli-1788679580551-bx4qxx.ts";

describe("Defect Remediation: defect-cli-1788679580551-bx4qxx", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679580551-bx4qxx");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-81",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679580551-bx4qxx",
      scope: ["olt/scripts/src/core/defect-cli-1788679580551-bx4qxx.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679580551-bx4qxx.test.ts",
      options: ["--compliant"],
    };
