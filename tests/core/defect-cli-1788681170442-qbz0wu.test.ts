...
} from "../../olt/scripts/src/core/defect-cli-1788681170442-qbz0wu.ts";

describe("Defect Remediation: defect-cli-1788681170442-qbz0wu", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681170442-qbz0wu");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-133",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788681170442-qbz0wu",
      scope: ["olt/scripts/src/core/defect-cli-1788681170442-qbz0wu.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788681170442-qbz0wu.test.ts",
      options: ["--compliant"],
    };
