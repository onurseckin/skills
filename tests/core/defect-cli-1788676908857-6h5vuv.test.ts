...
} from "../../olt/scripts/src/core/defect-cli-1788676908857-6h5vuv.ts";

describe("Defect Remediation: defect-cli-1788676908857-6h5vuv", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676908857-6h5vuv");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-4",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788676908857-6h5vuv",
      scope: ["olt/scripts/src/core/defect-cli-1788676908857-6h5vuv.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788676908857-6h5vuv.test.ts",
      options: ["--compliant"],
    };
