...
} from "../../olt/scripts/src/core/defect-cli-1788682417822-mlmd76.ts";

describe("Defect Remediation: defect-cli-1788682417822-mlmd76", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682417822-mlmd76");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-147",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682417822-mlmd76",
      scope: ["olt/scripts/src/core/defect-cli-1788682417822-mlmd76.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682417822-mlmd76.test.ts",
      options: ["--compliant"],
    };
