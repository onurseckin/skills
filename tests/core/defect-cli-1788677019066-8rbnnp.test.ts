...
} from "../../olt/scripts/src/core/defect-cli-1788677019066-8rbnnp.ts";

describe("Defect Remediation: defect-cli-1788677019066-8rbnnp", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677019066-8rbnnp");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-8",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677019066-8rbnnp",
      scope: ["olt/scripts/src/core/defect-cli-1788677019066-8rbnnp.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677019066-8rbnnp.test.ts",
      options: ["--compliant"],
    };
