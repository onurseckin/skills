...
} from "../../olt/scripts/src/core/defect-cli-1788681866702-wu4hoq.ts";

describe("Defect Remediation: defect-cli-1788681866702-wu4hoq", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681866702-wu4hoq");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-139",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788681866702-wu4hoq",
      scope: ["olt/scripts/src/core/defect-cli-1788681866702-wu4hoq.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788681866702-wu4hoq.test.ts",
      options: ["--compliant"],
    };
