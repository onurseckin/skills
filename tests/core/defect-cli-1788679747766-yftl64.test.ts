...
} from "../../olt/scripts/src/core/defect-cli-1788679747766-yftl64.ts";

describe("Defect Remediation: defect-cli-1788679747766-yftl64", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679747766-yftl64");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-90",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679747766-yftl64",
      scope: ["olt/scripts/src/core/defect-cli-1788679747766-yftl64.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679747766-yftl64.test.ts",
      options: ["--compliant"],
    };
