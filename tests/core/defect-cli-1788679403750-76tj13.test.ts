...
} from "../../olt/scripts/src/core/defect-cli-1788679403750-76tj13.ts";

describe("Defect Remediation: defect-cli-1788679403750-76tj13", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679403750-76tj13");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-65",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679403750-76tj13",
      scope: ["olt/scripts/src/core/defect-cli-1788679403750-76tj13.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679403750-76tj13.test.ts",
      options: ["--compliant"],
    };
