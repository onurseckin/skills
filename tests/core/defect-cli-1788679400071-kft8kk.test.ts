...
} from "../../olt/scripts/src/core/defect-cli-1788679400071-kft8kk.ts";

describe("Defect Remediation: defect-cli-1788679400071-kft8kk", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679400071-kft8kk");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-64",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679400071-kft8kk",
      scope: ["olt/scripts/src/core/defect-cli-1788679400071-kft8kk.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679400071-kft8kk.test.ts",
      options: ["--compliant"],
    };
