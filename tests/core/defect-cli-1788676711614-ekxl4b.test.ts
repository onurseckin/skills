...
} from "../../olt/scripts/src/core/defect-cli-1788676711614-ekxl4b.ts";

describe("Defect Remediation: defect-cli-1788676711614-ekxl4b", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676711614-ekxl4b");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-2",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788676711614-ekxl4b",
      scope: ["olt/scripts/src/core/defect-cli-1788676711614-ekxl4b.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788676711614-ekxl4b.test.ts",
      options: ["--compliant"],
    };
