...
} from "../../olt/scripts/src/core/defect-cli-1788682328233-w1ci6a.ts";

describe("Defect Remediation: defect-cli-1788682328233-w1ci6a", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682328233-w1ci6a");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-146",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682328233-w1ci6a",
      scope: ["olt/scripts/src/core/defect-cli-1788682328233-w1ci6a.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682328233-w1ci6a.test.ts",
      options: ["--compliant"],
    };
