...
} from "../../olt/scripts/src/core/defect-cli-1788679991229-87xfjv.ts";

describe("Defect Remediation: defect-cli-1788679991229-87xfjv", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679991229-87xfjv");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-104",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679991229-87xfjv",
      scope: ["olt/scripts/src/core/defect-cli-1788679991229-87xfjv.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679991229-87xfjv.test.ts",
      options: ["--compliant"],
    };
