...
} from "../../olt/scripts/src/core/defect-cli-1788679665540-defmso.ts";

describe("Defect Remediation: defect-cli-1788679665540-defmso", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679665540-defmso");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-84",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679665540-defmso",
      scope: ["olt/scripts/src/core/defect-cli-1788679665540-defmso.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679665540-defmso.test.ts",
      options: ["--compliant"],
    };
