...
} from "../../olt/scripts/src/core/defect-cli-1788679991228-rq1d9w.ts";

describe("Defect Remediation: defect-cli-1788679991228-rq1d9w", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679991228-rq1d9w");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-102",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679991228-rq1d9w",
      scope: ["olt/scripts/src/core/defect-cli-1788679991228-rq1d9w.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679991228-rq1d9w.test.ts",
      options: ["--compliant"],
    };
