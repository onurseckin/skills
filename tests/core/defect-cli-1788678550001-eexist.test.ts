...
} from "../../olt/scripts/src/core/defect-cli-1788678550001-eexist.ts";

describe("Defect Remediation: defect-cli-1788678550001-eexist", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678550001-eexist");
    expect(ERROR_CODE).toBe("EEXIST_FATAL_ERROR");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-28",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678550001-eexist",
      scope: ["olt/scripts/src/core/defect-cli-1788678550001-eexist.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678550001-eexist.test.ts",
      options: ["--compliant"],
    };
