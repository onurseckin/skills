...
} from "../../olt/scripts/src/core/defect-cli-1788680921240-2dyzzp.ts";

describe("Defect Remediation: defect-cli-1788680921240-2dyzzp", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680921240-2dyzzp");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-128",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680921240-2dyzzp",
      scope: ["olt/scripts/src/core/defect-cli-1788680921240-2dyzzp.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680921240-2dyzzp.test.ts",
      options: ["--compliant"],
    };
