...
} from "../../olt/scripts/src/core/defect-cli-1788679301626-ii543l.ts";

describe("Defect Remediation: defect-cli-1788679301626-ii543l", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679301626-ii543l");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-45",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679301626-ii543l",
      scope: ["olt/scripts/src/core/defect-cli-1788679301626-ii543l.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679301626-ii543l.test.ts",
      options: ["--compliant"],
    };
