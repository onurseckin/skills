...
} from "../../olt/scripts/src/core/defect-cli-1788677626666-e894ra.ts";

describe("Defect Remediation: defect-cli-1788677626666-e894ra", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677626666-e894ra");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-15",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677626666-e894ra",
      scope: ["olt/scripts/src/core/defect-cli-1788677626666-e894ra.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677626666-e894ra.test.ts",
      options: ["--compliant"],
    };
