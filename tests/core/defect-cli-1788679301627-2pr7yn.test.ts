...
} from "../../olt/scripts/src/core/defect-cli-1788679301627-2pr7yn.ts";

describe("Defect Remediation: defect-cli-1788679301627-2pr7yn", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679301627-2pr7yn");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-47",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679301627-2pr7yn",
      scope: ["olt/scripts/src/core/defect-cli-1788679301627-2pr7yn.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679301627-2pr7yn.test.ts",
      options: ["--compliant"],
    };
