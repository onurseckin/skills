...
} from "../../olt/scripts/src/core/defect-cli-1788679665540-vmzosl.ts";

describe("Defect Remediation: defect-cli-1788679665540-vmzosl", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679665540-vmzosl");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-87",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679665540-vmzosl",
      scope: ["olt/scripts/src/core/defect-cli-1788679665540-vmzosl.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679665540-vmzosl.test.ts",
      options: ["--compliant"],
    };
