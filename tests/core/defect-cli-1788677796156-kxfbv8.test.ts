...
} from "../../olt/scripts/src/core/defect-cli-1788677796156-kxfbv8.ts";

describe("Defect Remediation: defect-cli-1788677796156-kxfbv8", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677796156-kxfbv8");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-19",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677796156-kxfbv8",
      scope: ["olt/scripts/src/core/defect-cli-1788677796156-kxfbv8.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677796156-kxfbv8.test.ts",
      options: ["--compliant"],
    };
