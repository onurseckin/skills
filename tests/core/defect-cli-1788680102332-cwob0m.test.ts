...
} from "../../olt/scripts/src/core/defect-cli-1788680102332-cwob0m.ts";

describe("Defect Remediation: defect-cli-1788680102332-cwob0m", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680102332-cwob0m");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-109",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680102332-cwob0m",
      scope: ["olt/scripts/src/core/defect-cli-1788680102332-cwob0m.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680102332-cwob0m.test.ts",
      options: ["--compliant"],
    };
