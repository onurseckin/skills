...
} from "../../olt/scripts/src/core/defect-cli-1788682417823-3u1lr3.ts";

describe("Defect Remediation: defect-cli-1788682417823-3u1lr3", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682417823-3u1lr3");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-150",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682417823-3u1lr3",
      scope: ["olt/scripts/src/core/defect-cli-1788682417823-3u1lr3.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682417823-3u1lr3.test.ts",
      options: ["--compliant"],
    };
