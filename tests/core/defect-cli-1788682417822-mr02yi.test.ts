...
} from "../../olt/scripts/src/core/defect-cli-1788682417822-mr02yi.ts";

describe("Defect Remediation: defect-cli-1788682417822-mr02yi", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682417822-mr02yi");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-148",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682417822-mr02yi",
      scope: ["olt/scripts/src/core/defect-cli-1788682417822-mr02yi.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682417822-mr02yi.test.ts",
      options: ["--compliant"],
    };
