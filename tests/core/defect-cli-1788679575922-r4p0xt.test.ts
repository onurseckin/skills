...
} from "../../olt/scripts/src/core/defect-cli-1788679575922-r4p0xt.ts";

describe("Defect Remediation: defect-cli-1788679575922-r4p0xt", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679575922-r4p0xt");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-80",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679575922-r4p0xt",
      scope: ["olt/scripts/src/core/defect-cli-1788679575922-r4p0xt.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679575922-r4p0xt.test.ts",
      options: ["--compliant"],
    };
