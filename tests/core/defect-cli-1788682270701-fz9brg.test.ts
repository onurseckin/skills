...
} from "../../olt/scripts/src/core/defect-cli-1788682270701-fz9brg.ts";

describe("Defect Remediation: defect-cli-1788682270701-fz9brg", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682270701-fz9brg");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-141",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682270701-fz9brg",
      scope: ["olt/scripts/src/core/defect-cli-1788682270701-fz9brg.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682270701-fz9brg.test.ts",
      options: ["--compliant"],
    };
