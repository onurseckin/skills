...
} from "../../olt/scripts/src/core/defect-cli-1788676917981-4egjjw.ts";

describe("Defect Remediation: defect-cli-1788676917981-4egjjw", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676917981-4egjjw");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-6",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788676917981-4egjjw",
      scope: ["olt/scripts/src/core/defect-cli-1788676917981-4egjjw.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788676917981-4egjjw.test.ts",
      options: ["--compliant"],
    };
