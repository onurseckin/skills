...
} from "../../olt/scripts/src/core/defect-cli-1788677006990-uixom0.ts";

describe("Defect Remediation: defect-cli-1788677006990-uixom0", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677006990-uixom0");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-7",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677006990-uixom0",
      scope: ["olt/scripts/src/core/defect-cli-1788677006990-uixom0.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677006990-uixom0.test.ts",
      options: ["--compliant"],
    };
