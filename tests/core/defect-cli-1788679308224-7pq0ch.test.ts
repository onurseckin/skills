...
} from "../../olt/scripts/src/core/defect-cli-1788679308224-7pq0ch.ts";

describe("Defect Remediation: defect-cli-1788679308224-7pq0ch", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679308224-7pq0ch");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-53",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679308224-7pq0ch",
      scope: ["olt/scripts/src/core/defect-cli-1788679308224-7pq0ch.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679308224-7pq0ch.test.ts",
      options: ["--compliant"],
    };
