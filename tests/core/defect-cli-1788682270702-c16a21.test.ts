...
} from "../../olt/scripts/src/core/defect-cli-1788682270702-c16a21.ts";

describe("Defect Remediation: defect-cli-1788682270702-c16a21", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682270702-c16a21");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-142",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682270702-c16a21",
      scope: ["olt/scripts/src/core/defect-cli-1788682270702-c16a21.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682270702-c16a21.test.ts",
      options: ["--compliant"],
    };
