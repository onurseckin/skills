...
} from "../../olt/scripts/src/core/defect-cli-1788681068345-191292.ts";

describe("Defect Remediation: defect-cli-1788681068345-191292", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681068345-191292");
