...
} from "../../olt/scripts/src/core/defect-cli-1788682423090-ywkoqe.ts";

describe("Defect Remediation: defect-cli-1788682423090-ywkoqe", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682423090-ywkoqe");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-152",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682423090-ywkoqe",
      scope: ["olt/scripts/src/core/defect-cli-1788682423090-ywkoqe.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682423090-ywkoqe.test.ts",
      options: ["--compliant"],
    };
