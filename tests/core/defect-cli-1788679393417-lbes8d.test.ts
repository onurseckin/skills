...
} from "../../olt/scripts/src/core/defect-cli-1788679393417-lbes8d.ts";

describe("Defect Remediation: defect-cli-1788679393417-lbes8d", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679393417-lbes8d");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-62",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679393417-lbes8d",
      scope: ["olt/scripts/src/core/defect-cli-1788679393417-lbes8d.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679393417-lbes8d.test.ts",
      options: ["--compliant"],
    };
