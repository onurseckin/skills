...
} from "../../olt/scripts/src/core/defect-cli-1788681330164-xejvvf.ts";

describe("Defect Remediation: defect-cli-1788681330164-xejvvf", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681330164-xejvvf");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-134",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788681330164-xejvvf",
      scope: ["olt/scripts/src/core/defect-cli-1788681330164-xejvvf.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788681330164-xejvvf.test.ts",
      options: ["--compliant"],
    };
