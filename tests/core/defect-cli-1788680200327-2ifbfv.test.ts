...
} from "../../olt/scripts/src/core/defect-cli-1788680200327-2ifbfv.ts";

describe("Defect Remediation: defect-cli-1788680200327-2ifbfv", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680200327-2ifbfv");
