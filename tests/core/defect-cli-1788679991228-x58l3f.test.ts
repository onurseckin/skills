...
} from "../../olt/scripts/src/core/defect-cli-1788679991228-x58l3f.ts";

describe("Defect Remediation: defect-cli-1788679991228-x58l3f", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679991228-x58l3f");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-103",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679991228-x58l3f",
      scope: ["olt/scripts/src/core/defect-cli-1788679991228-x58l3f.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679991228-x58l3f.test.ts",
      options: ["--compliant"],
    };
