...
} from "../../olt/scripts/src/core/defect-cli-1788679665540-ve4jkp.ts";

describe("Defect Remediation: defect-cli-1788679665540-ve4jkp", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679665540-ve4jkp");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-86",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679665540-ve4jkp",
      scope: ["olt/scripts/src/core/defect-cli-1788679665540-ve4jkp.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679665540-ve4jkp.test.ts",
      options: ["--compliant"],
    };
