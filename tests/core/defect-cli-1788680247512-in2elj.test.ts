...
} from "../../olt/scripts/src/core/defect-cli-1788680247512-in2elj.ts";

describe("Defect Remediation: defect-cli-1788680247512-in2elj", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680247512-in2elj");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-118",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680247512-in2elj",
      scope: ["olt/scripts/src/core/defect-cli-1788680247512-in2elj.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680247512-in2elj.test.ts",
      options: ["--compliant"],
    };
