...
} from "../../olt/scripts/src/core/defect-cli-1788679301627-lttpii.ts";

describe("Defect Remediation: defect-cli-1788679301627-lttpii", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679301627-lttpii");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-48",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679301627-lttpii",
      scope: ["olt/scripts/src/core/defect-cli-1788679301627-lttpii.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679301627-lttpii.test.ts",
      options: ["--compliant"],
    };
