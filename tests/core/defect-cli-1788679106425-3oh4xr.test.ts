...
} from "../../olt/scripts/src/core/defect-cli-1788679106425-3oh4xr.ts";

describe("Defect Remediation: defect-cli-1788679106425-3oh4xr", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679106425-3oh4xr");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-38",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679106425-3oh4xr",
      scope: ["olt/scripts/src/core/defect-cli-1788679106425-3oh4xr.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679106425-3oh4xr.test.ts",
      options: ["--compliant"],
    };
