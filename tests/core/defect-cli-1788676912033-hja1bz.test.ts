...
} from "../../olt/scripts/src/core/defect-cli-1788676912033-hja1bz.ts";

describe("Defect Remediation: defect-cli-1788676912033-hja1bz", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676912033-hja1bz");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-5",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788676912033-hja1bz",
      scope: ["olt/scripts/src/core/defect-cli-1788676912033-hja1bz.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788676912033-hja1bz.test.ts",
      options: ["--compliant"],
    };
