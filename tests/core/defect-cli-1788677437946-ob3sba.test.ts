...
} from "../../olt/scripts/src/core/defect-cli-1788677437946-ob3sba.ts";

describe("Defect Remediation: defect-cli-1788677437946-ob3sba", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677437946-ob3sba");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-14",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677437946-ob3sba",
      scope: ["olt/scripts/src/core/defect-cli-1788677437946-ob3sba.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677437946-ob3sba.test.ts",
      options: ["--compliant"],
    };
