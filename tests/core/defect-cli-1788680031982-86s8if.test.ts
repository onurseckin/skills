...
} from "../../olt/scripts/src/core/defect-cli-1788680031982-86s8if.ts";

describe("Defect Remediation: defect-cli-1788680031982-86s8if", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680031982-86s8if");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-107",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680031982-86s8if",
      scope: ["olt/scripts/src/core/defect-cli-1788680031982-86s8if.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680031982-86s8if.test.ts",
      options: ["--compliant"],
    };
