...
} from "../../olt/scripts/src/core/defect-cli-1788677285517-ipv3hd.ts";

describe("Defect Remediation: defect-cli-1788677285517-ipv3hd", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677285517-ipv3hd");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-11",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677285517-ipv3hd",
      scope: ["olt/scripts/src/core/defect-cli-1788677285517-ipv3hd.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677285517-ipv3hd.test.ts",
      options: ["--compliant"],
    };
