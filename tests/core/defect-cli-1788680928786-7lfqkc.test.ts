...
} from "../../olt/scripts/src/core/defect-cli-1788680928786-7lfqkc.ts";

describe("Defect Remediation: defect-cli-1788680928786-7lfqkc", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680928786-7lfqkc");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-129",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680928786-7lfqkc",
      scope: ["olt/scripts/src/core/defect-cli-1788680928786-7lfqkc.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680928786-7lfqkc.test.ts",
      options: ["--compliant"],
    };
