...
} from "../../olt/scripts/src/core/defect-cli-1788681061729-e9t3rp.ts";

describe("Defect Remediation: defect-cli-1788681061729-e9t3rp", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681061729-e9t3rp");
    expect(ERROR_CODE).toBe("PATH_SAFETY");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      actor: "implementer_lane_3",
      role: "implementer",
      taskId: "task-131",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788681061729-e9t3rp",
      scope: ["olt/scripts/src/core/defect-cli-1788681061729-e9t3rp.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788681061729-e9t3rp.test.ts",
      options: ["--compliant"],
    };
