...
} from "../../olt/scripts/src/core/defect-cli-1788682273315-70vmvp.ts";

describe("Defect Remediation: defect-cli-1788682273315-70vmvp", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682273315-70vmvp");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-145",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682273315-70vmvp",
      scope: ["olt/scripts/src/core/defect-cli-1788682273315-70vmvp.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682273315-70vmvp.test.ts",
      options: ["--compliant"],
    };
