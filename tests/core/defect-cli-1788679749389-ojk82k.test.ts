...
} from "../../olt/scripts/src/core/defect-cli-1788679749389-ojk82k.ts";

describe("Defect Remediation: defect-cli-1788679749389-ojk82k", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679749389-ojk82k");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-95",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679749389-ojk82k",
      scope: ["olt/scripts/src/core/defect-cli-1788679749389-ojk82k.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679749389-ojk82k.test.ts",
      options: ["--compliant"],
    };
