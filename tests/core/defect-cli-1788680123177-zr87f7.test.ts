...
} from "../../olt/scripts/src/core/defect-cli-1788680123177-zr87f7.ts";

describe("Defect Remediation: defect-cli-1788680123177-zr87f7", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680123177-zr87f7");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-111",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680123177-zr87f7",
      scope: ["olt/scripts/src/core/defect-cli-1788680123177-zr87f7.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680123177-zr87f7.test.ts",
      options: ["--compliant"],
    };
