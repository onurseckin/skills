...
} from "../../olt/scripts/src/core/defect-cli-1788678483559-m5sxxv.ts";

describe("Defect Remediation: defect-cli-1788678483559-m5sxxv", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678483559-m5sxxv");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-27",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678483559-m5sxxv",
      scope: ["olt/scripts/src/core/defect-cli-1788678483559-m5sxxv.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678483559-m5sxxv.test.ts",
      options: ["--compliant"],
    };
