...
} from "../../olt/scripts/src/core/defect-cli-1788678214609-rvn1k5.ts";

describe("Defect Remediation: defect-cli-1788678214609-rvn1k5", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678214609-rvn1k5");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-24",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678214609-rvn1k5",
      scope: ["olt/scripts/src/core/defect-cli-1788678214609-rvn1k5.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678214609-rvn1k5.test.ts",
      options: ["--compliant"],
    };
