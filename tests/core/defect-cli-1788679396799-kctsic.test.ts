...
} from "../../olt/scripts/src/core/defect-cli-1788679396799-kctsic.ts";

describe("Defect Remediation: defect-cli-1788679396799-kctsic", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679396799-kctsic");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-63",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679396799-kctsic",
      scope: ["olt/scripts/src/core/defect-cli-1788679396799-kctsic.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679396799-kctsic.test.ts",
      options: ["--compliant"],
    };
