...
} from "../../olt/scripts/src/core/defect-cli-1788679299960-kb35im.ts";

describe("Defect Remediation: defect-cli-1788679299960-kb35im", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679299960-kb35im");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-43",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679299960-kb35im",
      scope: ["olt/scripts/src/core/defect-cli-1788679299960-kb35im.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679299960-kb35im.test.ts",
      options: ["--compliant"],
    };
