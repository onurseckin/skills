...
} from "../../olt/scripts/src/core/defect-cli-1788679936306-0nu7z7.ts";

describe("Defect Remediation: defect-cli-1788679936306-0nu7z7", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679936306-0nu7z7");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-100",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679936306-0nu7z7",
      scope: ["olt/scripts/src/core/defect-cli-1788679936306-0nu7z7.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679936306-0nu7z7.test.ts",
      options: ["--compliant"],
    };
