...
} from "../../olt/scripts/src/core/defect-cli-1788682542839-ri2qxk.ts";

describe("Defect Remediation: defect-cli-1788682542839-ri2qxk", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682542839-ri2qxk");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-153",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682542839-ri2qxk",
      scope: ["olt/scripts/src/core/defect-cli-1788682542839-ri2qxk.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682542839-ri2qxk.test.ts",
      options: ["--compliant"],
    };
