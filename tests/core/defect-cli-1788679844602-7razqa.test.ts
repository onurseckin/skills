...
} from "../../olt/scripts/src/core/defect-cli-1788679844602-7razqa.ts";

describe("Defect Remediation: defect-cli-1788679844602-7razqa", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679844602-7razqa");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-97",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679844602-7razqa",
      scope: ["olt/scripts/src/core/defect-cli-1788679844602-7razqa.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679844602-7razqa.test.ts",
      options: ["--compliant"],
    };
