...
} from "../../olt/scripts/src/core/defect-cli-1788679012846-46f2jp.ts";

describe("Defect Remediation: defect-cli-1788679012846-46f2jp", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679012846-46f2jp");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-34",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679012846-46f2jp",
      scope: ["olt/scripts/src/core/defect-cli-1788679012846-46f2jp.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679012846-46f2jp.test.ts",
      options: ["--compliant"],
    };
