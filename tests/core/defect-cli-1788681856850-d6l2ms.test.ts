...
} from "../../olt/scripts/src/core/defect-cli-1788681856850-d6l2ms.ts";

describe("Defect Remediation: defect-cli-1788681856850-d6l2ms", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788681856850-d6l2ms");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-138",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788681856850-d6l2ms",
      scope: ["olt/scripts/src/core/defect-cli-1788681856850-d6l2ms.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788681856850-d6l2ms.test.ts",
      options: ["--compliant"],
    };
