...
} from "../../olt/scripts/src/core/defect-cli-1788676743670-5w2wt2.ts";

describe("Defect Remediation: defect-cli-1788676743670-5w2wt2", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788676743670-5w2wt2");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-3",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788676743670-5w2wt2",
      scope: ["olt/scripts/src/core/defect-cli-1788676743670-5w2wt2.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788676743670-5w2wt2.test.ts",
      options: ["--compliant"],
    };
