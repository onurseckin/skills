...
} from "../../olt/scripts/src/core/defect-cli-1788679722591-65ekwx.ts";

describe("Defect Remediation: defect-cli-1788679722591-65ekwx", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679722591-65ekwx");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-88",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679722591-65ekwx",
      scope: ["olt/scripts/src/core/defect-cli-1788679722591-65ekwx.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679722591-65ekwx.test.ts",
      options: ["--compliant"],
    };
