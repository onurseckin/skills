...
} from "../../olt/scripts/src/core/defect-cli-1788682270700-5qyk3x.ts";

describe("Defect Remediation: defect-cli-1788682270700-5qyk3x", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788682270700-5qyk3x");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-140",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788682270700-5qyk3x",
      scope: ["olt/scripts/src/core/defect-cli-1788682270700-5qyk3x.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788682270700-5qyk3x.test.ts",
      options: ["--compliant"],
    };
