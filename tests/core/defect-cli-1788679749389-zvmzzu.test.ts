...
} from "../../olt/scripts/src/core/defect-cli-1788679749389-zvmzzu.ts";

describe("Defect Remediation: defect-cli-1788679749389-zvmzzu", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679749389-zvmzzu");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-94",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679749389-zvmzzu",
      scope: ["olt/scripts/src/core/defect-cli-1788679749389-zvmzzu.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679749389-zvmzzu.test.ts",
      options: ["--compliant"],
    };
