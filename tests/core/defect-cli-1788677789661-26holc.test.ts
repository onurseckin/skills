...
} from "../../olt/scripts/src/core/defect-cli-1788677789661-26holc.ts";

describe("Defect Remediation: defect-cli-1788677789661-26holc", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677789661-26holc");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-18",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677789661-26holc",
      scope: ["olt/scripts/src/core/defect-cli-1788677789661-26holc.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677789661-26holc.test.ts",
      options: ["--compliant"],
    };
