...
} from "../../olt/scripts/src/core/defect-cli-1788679665540-rfb6vu.ts";

describe("Defect Remediation: defect-cli-1788679665540-rfb6vu", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679665540-rfb6vu");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-85",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679665540-rfb6vu",
      scope: ["olt/scripts/src/core/defect-cli-1788679665540-rfb6vu.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679665540-rfb6vu.test.ts",
      options: ["--compliant"],
    };
