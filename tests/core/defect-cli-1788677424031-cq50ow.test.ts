...
} from "../../olt/scripts/src/core/defect-cli-1788677424031-cq50ow.ts";

describe("Defect Remediation: defect-cli-1788677424031-cq50ow", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788677424031-cq50ow");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-13",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788677424031-cq50ow",
      scope: ["olt/scripts/src/core/defect-cli-1788677424031-cq50ow.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788677424031-cq50ow.test.ts",
      options: ["--compliant"],
    };
