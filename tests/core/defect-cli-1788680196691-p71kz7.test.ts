...
} from "../../olt/scripts/src/core/defect-cli-1788680196691-p71kz7.ts";

describe("Defect Remediation: defect-cli-1788680196691-p71kz7", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788680196691-p71kz7");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-115",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788680196691-p71kz7",
      scope: ["olt/scripts/src/core/defect-cli-1788680196691-p71kz7.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788680196691-p71kz7.test.ts",
      options: ["--compliant"],
    };
