...
} from "../../olt/scripts/src/core/defect-cli-1788679888559-xkqmqe.ts";

describe("Defect Remediation: defect-cli-1788679888559-xkqmqe", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679888559-xkqmqe");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-99",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679888559-xkqmqe",
      scope: ["olt/scripts/src/core/defect-cli-1788679888559-xkqmqe.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679888559-xkqmqe.test.ts",
      options: ["--compliant"],
    };
