...
} from "../../olt/scripts/src/core/defect-cli-1788679534444-3zt8qk.ts";

describe("Defect Remediation: defect-cli-1788679534444-3zt8qk", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788679534444-3zt8qk");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-75",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788679534444-3zt8qk",
      scope: ["olt/scripts/src/core/defect-cli-1788679534444-3zt8qk.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788679534444-3zt8qk.test.ts",
      options: ["--compliant"],
    };
