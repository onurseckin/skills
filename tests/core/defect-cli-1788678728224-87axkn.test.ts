...
} from "../../olt/scripts/src/core/defect-cli-1788678728224-87axkn.ts";

describe("Defect Remediation: defect-cli-1788678728224-87axkn", () => {
  test("exports constants and defect metadata", () => {
    expect(DEFECT_ID).toBe("defect-cli-1788678728224-87axkn");
  ...
  test("validates compliant execution context cleanly", () => {
    const validCtx: DefectRemediationContext = {
      ...
      taskId: "task-29",
      state: "validating",
      sessionToken: "tok_live_core_defect-cli-1788678728224-87axkn",
      scope: ["olt/scripts/src/core/defect-cli-1788678728224-87axkn.ts"],
      gateCommand: "bun test tests/core/defect-cli-1788678728224-87axkn.test.ts",
      options: ["--compliant"],
    };
