...
export const aggregatorSuiteName = "Defect Entry Aggregator";

describe(aggregatorSuiteName, () => {
  ...
  describe("aggregateDefectEntries", () => {
    ...
    test("preserves resolved status and resolution proof", () => {
      ...
      const proof: DefectResolutionProof = {
        task_id: "task-fix-1",
        test_assertion: "bun test tests/defects/aggregation/aggregator.test.ts",
