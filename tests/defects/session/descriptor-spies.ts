 ...
 * Spies for open descriptors, truncation, fstat, and platform flock for defects domain.
 */
...
export function createDescriptorSpies(s: VirtualDefectsState): Array<{ mockRestore: () => void }> {
