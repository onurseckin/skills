...
export { HarnessError } from "../../olt/scripts/src/core/errors/index.ts";
...
} from "../../olt/scripts/src/ui-validation/index.ts";
...
export type {
  ...
  ApplicationEndpoints, RunningPortInfo, CookieTemplateSpec, PersonaDefinition, FeatureScope,
  DeductiveParameters, ExtractionValidationResult, SessionCookie, LocalStorageEntry, BrowserStorageOrigin,
  BrowserStorageState, PersonaSessionContext, SessionDegradationCause, SessionDegradationInspectionParams,
  SessionDegradationResult, ReauthExecutionPlan, PermissionAuditExpectation, PersonaAccessEvaluation,
  PermissionBoundaryAuditResult, SyntheticFixtureType, SyntheticFixture, SchemaFieldRule, PayloadSchema,
  PreFlightCertificationResult, RoutedDefectReceipt, VisualFoundationHandoffToken, HandoffVerificationResult,
  DisambiguationEvaluationResult, ZIndexLayer, ZIndexRange, ViewportSpecification, ViewportPresetName,
  CanonicalStressInputKey, JourneyActionType, JourneyStep, JourneyFlow, JourneyStepResult,
  BreadcrumbVerificationResult, JourneyFlowResult, JourneyStepHandlerContext, JourneyStepHandler,
  FormFieldType, FormFieldDescriptor, ValidationBannerInfo, OverflowInspectionResult, FormStressFieldResult,
  FormStressTestPlan, FormStressTestResult, FormFieldEvaluationInput, OverlayType, OverlayDescriptor,
  ZIndexHierarchyViolation, ElementBounds, ElementLayoutNode, BackdropOcclusionResult,
  OverlayDismissalErgonomicsResult, TouchHitbox, TouchHitboxResult, MobileMenuTransitionMetrics,
  MobileMenuTransitionResult, BreakpointLayoutMetrics, BreakpointReflowResult, GpuAcceleratedProperty,
  LayoutTriggeringProperty, SpringPresetConfig, SpringPresetKey, SpringPresetName, FrameSample,
  LayoutShiftSample, AnimatedPropertyAudit, MotionHeadlessPreFlightInput, MotionHeadlessPreFlightResult,
  KeyframeSamplePoint, TemporalKeyframeInspectionInput, TemporalKeyframeInspectionResult,
  FocusRingMetrics, FocusRingInspectionResult, HoverLiftMetrics, HoverLiftInspectionResult,
  TrajectoryPoint, SpringPhysicsInspectionInput, SpringPhysicsInspectionResult, CompositeArtifactKey,
  EvidenceTier, ArtifactMetadata, OpticalStabilityInput, OpticalStabilityResult, EvidenceStorageStats,
  PixelDeltaSeverity, PixelCoordinate, BoundingBox, VisualDeltaInput, VisualDeltaReport,
  ViewportProfileName, ViewportDimension, PermutationSurface, RgbColor, ContrastAuditTarget,
  ContrastAuditResult, SurfaceContrastReport, PermutationInspectionState, ThematicGateReport,
  ThemeFlashDetectionInput, ThemeFlashReport, DarkDepthInput, DarkDepthReport, HighContrastBoundaryInput,
  HighContrastBoundaryReport, OpticalDimension, OpticalDimensionMeta, IndustryProfileId,
  AestheticProfile, UiElementDescriptor, UiDescriptor, OpticalViolation, SocraticCritiqueChallenge,
  AestheticEvaluationReport, SpacingTokenName, SpacingTokenValue, FontFamilyToken, FontSizeToken,
  FontWeightToken, LineHeightToken, LetterSpacingToken, ThemeMode, ColorRoleTokens, ColorRole,
  ShadowElevationToken, BorderRadiiToken, TransitionDurationToken, TransitionEasingToken,
  RawValueViolation, RawValueValidationResult, StyleAdjustmentRequest, TokenImmunityDefense,
  TokenCompositionDescriptor, CompositionRecommendation, CompositionEvaluationResult, TokenProposalStatus,
  TokenEvolutionProposal, TokenRegistrySnapshot, MilestoneLockStatus, UnlockRecord, ImmutabilityManifest,
  SealMilestoneInput, EmpiricalRegressionProof, OpticalRegressionUnlockToken, ManifestIntegrityResult,
  LockSystemIntegrityReport, ScopeMutationRequest, SocraticRoundNumber, SocraticRoundId,
  SocraticRoundDefinition, CognitiveChallengeSeverity, CognitiveChallengeStatus, DefenseRecord,
  CognitiveChallenge, CreateChallengeInput, DefenseSubmission, DefenseEvaluationResult, CollateralDefect,
  InterRoundAuditResult, CompetingForce, CandidateResolution, ParetoArbitrationInput,
  ParetoArbitrationDecision, RoundGateEvaluation, RoundAdvanceResult, SocraticSessionSummary,
