...
describe("Socratic Dialectic - End-to-End Milestone Lock Integrity", () => {
  beforeEach(() => {
    resetDefaultMilestoneLockEngine();
    resetDefaultSocraticDialecticEngine();
  });
  ...
  describe("11. End-to-End Cryptographic Manifest Integrity", () => {
    it("should maintain cryptographic lock integrity and session summary across all 5 sealed manifests", () => {
      const engine = new SocraticDialecticEngine({ sessionId: "e2e-dialectics-integrity" });
