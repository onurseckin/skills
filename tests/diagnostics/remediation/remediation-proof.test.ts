...
describe("Diagnostics Remediation Proof & Static Quality Invariants", () => {
  ...
  describe("Resolution Proof Lifecycle & Validation", () => {
    test("successfully resolves defect with complete and verified proof", () => {
      const validProof: DefectResolutionProof = {
        ...
        test_assertion: "bun test tests/diagnostics/remediation/remediation-proof.test.ts",
      ...
      expect(resolved.resolution?.test_assertion).toBe(
        "bun test tests/diagnostics/remediation/remediation-proof.test.ts",
      );
  ...
  describe("Static Quality Invariant Verification", () => {
    ...
    const filesToAudit = [
      ...
      "tests/diagnostics/defects/defect-ingestion.test.ts",
      "tests/diagnostics/defects/defect-categorization.test.ts",
      "tests/diagnostics/pushback/pushback-ingestion.test.ts",
      "tests/diagnostics/remediation/dual-state-remediation.test.ts",
      "tests/diagnostics/remediation/remediation-proof.test.ts",
    ];
